...
pub fn exec<'a>(
    ...
    loop {
        ...
        match (npw2, lnpw2, opc) {
            ...
            (5, 5, 0x006) => ex!{|s| extend_const8_u a: [u32;8],  b },
            (6, 6, 0x006) => ex!{|s| extend_const8_u a: [u32;16], b },
            ...
            (5, 5, 0x007) => ex!{|s| extend_const8_s a: [u32;8],  b },
            (6, 6, 0x007) => ex!{|s| extend_const8_s a: [u32;16], b },
            ...
            (5, 5, 0x008) => ex!{|s| splat_const8 a: [u32;8],  b },
            (6, 6, 0x008) => ex!{|s| splat_const8 a: [u32;16], b },
            ...
            (5, 0, 0x009) => ex!{|s| extend_u a: [u32;8],  b: [u32;8]  },
            (5, 1, 0x009) => ex!{|s| extend_u a: [u32;8],  b: u128     },
            (5, 2, 0x009) => ex!{|s| extend_u a: [u32;8],  b: u64      },
            (5, 3, 0x009) => ex!{|s| extend_u a: [u32;8],  b: u32      },
            (5, 4, 0x009) => ex!{|s| extend_u a: [u32;8],  b: u16      },
            (5, 5, 0x009) => ex!{|s| extend_u a: [u32;8],  b: u8       },

            (6, 0, 0x009) => ex!{|s| extend_u a: [u32;16], b: [u32;16] },
            (6, 1, 0x009) => ex!{|s| extend_u a: [u32;16], b: [u32;8]  },
            (6, 2, 0x009) => ex!{|s| extend_u a: [u32;16], b: u128     },
            (6, 3, 0x009) => ex!{|s| extend_u a: [u32;16], b: u64      },
            (6, 4, 0x009) => ex!{|s| extend_u a: [u32;16], b: u32      },
            (6, 5, 0x009) => ex!{|s| extend_u a: [u32;16], b: u16      },
            (6, 6, 0x009) => ex!{|s| extend_u a: [u32;16], b: u8       },
            ...
            (5, 0, 0x00a) => ex!{|s| extend_s a: [u32;8],  b: [u32;8]  },
            (5, 1, 0x00a) => ex!{|s| extend_s a: [u32;8],  b: u128     },
            (5, 2, 0x00a) => ex!{|s| extend_s a: [u32;8],  b: u64      },
            (5, 3, 0x00a) => ex!{|s| extend_s a: [u32;8],  b: u32      },
            (5, 4, 0x00a) => ex!{|s| extend_s a: [u32;8],  b: u16      },
            (5, 5, 0x00a) => ex!{|s| extend_s a: [u32;8],  b: u8       },

            (6, 0, 0x00a) => ex!{|s| extend_s a: [u32;16], b: [u32;16] },
            (6, 1, 0x00a) => ex!{|s| extend_s a: [u32;16], b: [u32;8]  },
            (6, 2, 0x00a) => ex!{|s| extend_s a: [u32;16], b: u128     },
            (6, 3, 0x00a) => ex!{|s| extend_s a: [u32;16], b: u64      },
            (6, 4, 0x00a) => ex!{|s| extend_s a: [u32;16], b: u32      },
            (6, 5, 0x00a) => ex!{|s| extend_s a: [u32;16], b: u16      },
            (6, 6, 0x00a) => ex!{|s| extend_s a: [u32;16], b: u8       },
            ...
            (5, 0, 0x00b) => ex!{|s| splat a: [u32;8],  b: [u32;8]  },
            (5, 1, 0x00b) => ex!{|s| splat a: [u32;8],  b: u128     },
            (5, 2, 0x00b) => ex!{|s| splat a: [u32;8],  b: u64      },
            (5, 3, 0x00b) => ex!{|s| splat a: [u32;8],  b: u32      },
            (5, 4, 0x00b) => ex!{|s| splat a: [u32;8],  b: u16      },
            (5, 5, 0x00b) => ex!{|s| splat a: [u32;8],  b: u8       },

            (6, 0, 0x00b) => ex!{|s| splat a: [u32;16], b: [u32;16] },
            (6, 1, 0x00b) => ex!{|s| splat a: [u32;16], b: [u32;8]  },
            (6, 2, 0x00b) => ex!{|s| splat a: [u32;16], b: u128     },
            (6, 3, 0x00b) => ex!{|s| splat a: [u32;16], b: u64      },
            (6, 4, 0x00b) => ex!{|s| splat a: [u32;16], b: u32      },
            (6, 5, 0x00b) => ex!{|s| splat a: [u32;16], b: u16      },
            (6, 6, 0x00b) => ex!{|s| splat a: [u32;16], b: u8       },
            ...
            (5, 0..=5, 0x00c) => ex!{|s| none a: [u32;8],  b: [u32;8]  },
            (6, 0..=6, 0x00c) => ex!{|s| none a: [u32;16], b: [u32;16] },

            // all
            (0, 0, 0x00d) => ex!{|s| all a: u8,       b: u8;1       },

            (1, 0, 0x00d) => ex!{|s| all a: u16,      b: u16;1      },
            (1, 1, 0x00d) => ex!{|s| all a: u16,      b: u8;2       },

            (2, 0, 0x00d) => ex!{|s| all a: u32,      b: u32;1      },
            (2, 1, 0x00d) => ex!{|s| all a: u32,      b: u16;2      },
            (2, 2, 0x00d) => ex!{|s| all a: u32,      b: u8;4       },

            (3, 0, 0x00d) => ex!{|s| all a: u64,      b: u64;1      },
            (3, 1, 0x00d) => ex!{|s| all a: u64,      b: u32;2      },
            (3, 2, 0x00d) => ex!{|s| all a: u64,      b: u16;4      },
            (3, 3, 0x00d) => ex!{|s| all a: u64,      b: u8;8       },

            (4, 0, 0x00d) => ex!{|s| all a: u128,     b: u128;1     },
            (4, 1, 0x00d) => ex!{|s| all a: u128,     b: u64;2      },
            (4, 2, 0x00d) => ex!{|s| all a: u128,     b: u32;4      },
            (4, 3, 0x00d) => ex!{|s| all a: u128,     b: u16;8      },
            (4, 4, 0x00d) => ex!{|s| all a: u128,     b: u8;16      },

            (5, 0, 0x00d) => ex!{|s| all a: [u32;8],  b: [u32;8];1  },
            (5, 1, 0x00d) => ex!{|s| all a: [u32;8],  b: u128;2     },
            (5, 2, 0x00d) => ex!{|s| all a: [u32;8],  b: u64;4      },
            (5, 3, 0x00d) => ex!{|s| all a: [u32;8],  b: u32;8      },
            (5, 4, 0x00d) => ex!{|s| all a: [u32;8],  b: u16;16     },
            (5, 5, 0x00d) => ex!{|s| all a: [u32;8],  b: u8;32      },

            (6, 0, 0x00d) => ex!{|s| all a: [u32;16], b: [u32;16];1 },
            (6, 1, 0x00d) => ex!{|s| all a: [u32;16], b: [u32;8];2  },
            (6, 2, 0x00d) => ex!{|s| all a: [u32;16], b: u128;4     },
            (6, 3, 0x00d) => ex!{|s| all a: [u32;16], b: u64;8      },
            (6, 4, 0x00d) => ex!{|s| all a: [u32;16], b: u32;16     },
            (6, 5, 0x00d) => ex!{|s| all a: [u32;16], b: u16;32     },
            (6, 6, 0x00d) => ex!{|s| all a: [u32;16], b: u8;64      },

            // eq
            (0, 0, 0x00e) => ex!{|s| eq a: u8,       b: u8;1       },

            (1, 0, 0x00e) => ex!{|s| eq a: u16,      b: u16;1      },
            (1, 1, 0x00e) => ex!{|s| eq a: u16,      b: u8;2       },

            (2, 0, 0x00e) => ex!{|s| eq a: u32,      b: u32;1      },
            (2, 1, 0x00e) => ex!{|s| eq a: u32,      b: u16;2      },
            (2, 2, 0x00e) => ex!{|s| eq a: u32,      b: u8;4       },

            (3, 0, 0x00e) => ex!{|s| eq a: u64,      b: u64;1      },
            (3, 1, 0x00e) => ex!{|s| eq a: u64,      b: u32;2      },
            (3, 2, 0x00e) => ex!{|s| eq a: u64,      b: u16;4      },
            (3, 3, 0x00e) => ex!{|s| eq a: u64,      b: u8;8       },

            (4, 0, 0x00e) => ex!{|s| eq a: u128,     b: u128;1     },
            (4, 1, 0x00e) => ex!{|s| eq a: u128,     b: u64;2      },
            (4, 2, 0x00e) => ex!{|s| eq a: u128,     b: u32;4      },
            (4, 3, 0x00e) => ex!{|s| eq a: u128,     b: u16;8      },
            (4, 4, 0x00e) => ex!{|s| eq a: u128,     b: u8;16      },

            (5, 0, 0x00e) => ex!{|s| eq a: [u32;8],  b: [u32;8];1  },
            (5, 1, 0x00e) => ex!{|s| eq a: [u32;8],  b: u128;2     },
            (5, 2, 0x00e) => ex!{|s| eq a: [u32;8],  b: u64;4      },
            (5, 3, 0x00e) => ex!{|s| eq a: [u32;8],  b: u32;8      },
            (5, 4, 0x00e) => ex!{|s| eq a: [u32;8],  b: u16;16     },
            (5, 5, 0x00e) => ex!{|s| eq a: [u32;8],  b: u8;32      },

            (6, 0, 0x00e) => ex!{|s| eq a: [u32;16], b: [u32;16];1 },
            (6, 1, 0x00e) => ex!{|s| eq a: [u32;16], b: [u32;8];2  },
            (6, 2, 0x00e) => ex!{|s| eq a: [u32;16], b: u128;4     },
            (6, 3, 0x00e) => ex!{|s| eq a: [u32;16], b: u64;8      },
            (6, 4, 0x00e) => ex!{|s| eq a: [u32;16], b: u32;16     },
            (6, 5, 0x00e) => ex!{|s| eq a: [u32;16], b: u16;32     },
            (6, 6, 0x00e) => ex!{|s| eq a: [u32;16], b: u8;64      },

            // ne
            (0, 0, 0x00f) => ex!{|s| ne a: u8,       b: u8;1       },

            (1, 0, 0x00f) => ex!{|s| ne a: u16,      b: u16;1      },
            (1, 1, 0x00f) => ex!{|s| ne a: u16,      b: u8;2       },

            (2, 0, 0x00f) => ex!{|s| ne a: u32,      b: u32;1      },
            (2, 1, 0x00f) => ex!{|s| ne a: u32,      b: u16;2      },
            (2, 2, 0x00f) => ex!{|s| ne a: u32,      b: u8;4       },

            (3, 0, 0x00f) => ex!{|s| ne a: u64,      b: u64;1      },
            (3, 1, 0x00f) => ex!{|s| ne a: u64,      b: u32;2      },
            (3, 2, 0x00f) => ex!{|s| ne a: u64,      b: u16;4      },
            (3, 3, 0x00f) => ex!{|s| ne a: u64,      b: u8;8       },

            (4, 0, 0x00f) => ex!{|s| ne a: u128,     b: u128;1     },
            (4, 1, 0x00f) => ex!{|s| ne a: u128,     b: u64;2      },
            (4, 2, 0x00f) => ex!{|s| ne a: u128,     b: u32;4      },
            (4, 3, 0x00f) => ex!{|s| ne a: u128,     b: u16;8      },
            (4, 4, 0x00f) => ex!{|s| ne a: u128,     b: u8;16      },

            (5, 0, 0x00f) => ex!{|s| ne a: [u32;8],  b: [u32;8];1  },
            (5, 1, 0x00f) => ex!{|s| ne a: [u32;8],  b: u128;2     },
            (5, 2, 0x00f) => ex!{|s| ne a: [u32;8],  b: u64;4      },
            (5, 3, 0x00f) => ex!{|s| ne a: [u32;8],  b: u32;8      },
            (5, 4, 0x00f) => ex!{|s| ne a: [u32;8],  b: u16;16     },
            (5, 5, 0x00f) => ex!{|s| ne a: [u32;8],  b: u8;32      },

            (6, 0, 0x00f) => ex!{|s| ne a: [u32;16], b: [u32;16];1 },
            (6, 1, 0x00f) => ex!{|s| ne a: [u32;16], b: [u32;8];2  },
            (6, 2, 0x00f) => ex!{|s| ne a: [u32;16], b: u128;4     },
            (6, 3, 0x00f) => ex!{|s| ne a: [u32;16], b: u64;8      },
            (6, 4, 0x00f) => ex!{|s| ne a: [u32;16], b: u32;16     },
            (6, 5, 0x00f) => ex!{|s| ne a: [u32;16], b: u16;32     },
            (6, 6, 0x00f) => ex!{|s| ne a: [u32;16], b: u8;64      },

            // lt_u
            (0, 0, 0x010) => ex!{|s| lt_u a: u8,       b: u8;1       },

            (1, 0, 0x010) => ex!{|s| lt_u a: u16,      b: u16;1      },
            (1, 1, 0x010) => ex!{|s| lt_u a: u16,      b: u8;2       },

            (2, 0, 0x010) => ex!{|s| lt_u a: u32,      b: u32;1      },
            (2, 1, 0x010) => ex!{|s| lt_u a: u32,      b: u16;2      },
            (2, 2, 0x010) => ex!{|s| lt_u a: u32,      b: u8;4       },

            (3, 0, 0x010) => ex!{|s| lt_u a: u64,      b: u64;1      },
            (3, 1, 0x010) => ex!{|s| lt_u a: u64,      b: u32;2      },
            (3, 2, 0x010) => ex!{|s| lt_u a: u64,      b: u16;4      },
            (3, 3, 0x010) => ex!{|s| lt_u a: u64,      b: u8;8       },

            (4, 0, 0x010) => ex!{|s| lt_u a: u128,     b: u128;1     },
            (4, 1, 0x010) => ex!{|s| lt_u a: u128,     b: u64;2      },
            (4, 2, 0x010) => ex!{|s| lt_u a: u128,     b: u32;4      },
            (4, 3, 0x010) => ex!{|s| lt_u a: u128,     b: u16;8      },
            (4, 4, 0x010) => ex!{|s| lt_u a: u128,     b: u8;16      },

            (5, 0, 0x010) => ex!{|s| lt_u a: [u32;8],  b: [u32;8];1  },
            (5, 1, 0x010) => ex!{|s| lt_u a: [u32;8],  b: u128;2     },
            (5, 2, 0x010) => ex!{|s| lt_u a: [u32;8],  b: u64;4      },
            (5, 3, 0x010) => ex!{|s| lt_u a: [u32;8],  b: u32;8      },
            (5, 4, 0x010) => ex!{|s| lt_u a: [u32;8],  b: u16;16     },
            (5, 5, 0x010) => ex!{|s| lt_u a: [u32;8],  b: u8;32      },

            (6, 0, 0x010) => ex!{|s| lt_u a: [u32;16], b: [u32;16];1 },
            (6, 1, 0x010) => ex!{|s| lt_u a: [u32;16], b: [u32;8];2  },
            (6, 2, 0x010) => ex!{|s| lt_u a: [u32;16], b: u128;4     },
            (6, 3, 0x010) => ex!{|s| lt_u a: [u32;16], b: u64;8      },
            (6, 4, 0x010) => ex!{|s| lt_u a: [u32;16], b: u32;16     },
            (6, 5, 0x010) => ex!{|s| lt_u a: [u32;16], b: u16;32     },
            (6, 6, 0x010) => ex!{|s| lt_u a: [u32;16], b: u8;64      },

            // lt_s
            (0, 0, 0x011) => ex!{|s| lt_s a: u8,       b: u8;1       },

            (1, 0, 0x011) => ex!{|s| lt_s a: u16,      b: u16;1      },
            (1, 1, 0x011) => ex!{|s| lt_s a: u16,      b: u8;2       },

            (2, 0, 0x011) => ex!{|s| lt_s a: u32,      b: u32;1      },
            (2, 1, 0x011) => ex!{|s| lt_s a: u32,      b: u16;2      },
            (2, 2, 0x011) => ex!{|s| lt_s a: u32,      b: u8;4       },

            (3, 0, 0x011) => ex!{|s| lt_s a: u64,      b: u64;1      },
            (3, 1, 0x011) => ex!{|s| lt_s a: u64,      b: u32;2      },
            (3, 2, 0x011) => ex!{|s| lt_s a: u64,      b: u16;4      },
            (3, 3, 0x011) => ex!{|s| lt_s a: u64,      b: u8;8       },

            (4, 0, 0x011) => ex!{|s| lt_s a: u128,     b: u128;1     },
            (4, 1, 0x011) => ex!{|s| lt_s a: u128,     b: u64;2      },
            (4, 2, 0x011) => ex!{|s| lt_s a: u128,     b: u32;4      },
            (4, 3, 0x011) => ex!{|s| lt_s a: u128,     b: u16;8      },
            (4, 4, 0x011) => ex!{|s| lt_s a: u128,     b: u8;16      },

            (5, 0, 0x011) => ex!{|s| lt_s a: [u32;8],  b: [u32;8];1  },
            (5, 1, 0x011) => ex!{|s| lt_s a: [u32;8],  b: u128;2     },
            (5, 2, 0x011) => ex!{|s| lt_s a: [u32;8],  b: u64;4      },
            (5, 3, 0x011) => ex!{|s| lt_s a: [u32;8],  b: u32;8      },
            (5, 4, 0x011) => ex!{|s| lt_s a: [u32;8],  b: u16;16     },
            (5, 5, 0x011) => ex!{|s| lt_s a: [u32;8],  b: u8;32      },

            (6, 0, 0x011) => ex!{|s| lt_s a: [u32;16], b: [u32;16];1 },
            (6, 1, 0x011) => ex!{|s| lt_s a: [u32;16], b: [u32;8];2  },
            (6, 2, 0x011) => ex!{|s| lt_s a: [u32;16], b: u128;4     },
            (6, 3, 0x011) => ex!{|s| lt_s a: [u32;16], b: u64;8      },
            (6, 4, 0x011) => ex!{|s| lt_s a: [u32;16], b: u32;16     },
            (6, 5, 0x011) => ex!{|s| lt_s a: [u32;16], b: u16;32     },
            (6, 6, 0x011) => ex!{|s| lt_s a: [u32;16], b: u8;64      },

            // gt_u
            (0, 0, 0x012) => ex!{|s| gt_u a: u8,       b: u8;1       },

            (1, 0, 0x012) => ex!{|s| gt_u a: u16,      b: u16;1      },
            (1, 1, 0x012) => ex!{|s| gt_u a: u16,      b: u8;2       },

            (2, 0, 0x012) => ex!{|s| gt_u a: u32,      b: u32;1      },
            (2, 1, 0x012) => ex!{|s| gt_u a: u32,      b: u16;2      },
            (2, 2, 0x012) => ex!{|s| gt_u a: u32,      b: u8;4       },

            (3, 0, 0x012) => ex!{|s| gt_u a: u64,      b: u64;1      },
            (3, 1, 0x012) => ex!{|s| gt_u a: u64,      b: u32;2      },
            (3, 2, 0x012) => ex!{|s| gt_u a: u64,      b: u16;4      },
            (3, 3, 0x012) => ex!{|s| gt_u a: u64,      b: u8;8       },

            (4, 0, 0x012) => ex!{|s| gt_u a: u128,     b: u128;1     },
            (4, 1, 0x012) => ex!{|s| gt_u a: u128,     b: u64;2      },
            (4, 2, 0x012) => ex!{|s| gt_u a: u128,     b: u32;4      },
            (4, 3, 0x012) => ex!{|s| gt_u a: u128,     b: u16;8      },
            (4, 4, 0x012) => ex!{|s| gt_u a: u128,     b: u8;16      },

            (5, 0, 0x012) => ex!{|s| gt_u a: [u32;8],  b: [u32;8];1  },
            (5, 1, 0x012) => ex!{|s| gt_u a: [u32;8],  b: u128;2     },
            (5, 2, 0x012) => ex!{|s| gt_u a: [u32;8],  b: u64;4      },
            (5, 3, 0x012) => ex!{|s| gt_u a: [u32;8],  b: u32;8      },
            (5, 4, 0x012) => ex!{|s| gt_u a: [u32;8],  b: u16;16     },
            (5, 5, 0x012) => ex!{|s| gt_u a: [u32;8],  b: u8;32      },

            (6, 0, 0x012) => ex!{|s| gt_u a: [u32;16], b: [u32;16];1 },
            (6, 1, 0x012) => ex!{|s| gt_u a: [u32;16], b: [u32;8];2  },
            (6, 2, 0x012) => ex!{|s| gt_u a: [u32;16], b: u128;4     },
            (6, 3, 0x012) => ex!{|s| gt_u a: [u32;16], b: u64;8      },
            (6, 4, 0x012) => ex!{|s| gt_u a: [u32;16], b: u32;16     },
            (6, 5, 0x012) => ex!{|s| gt_u a: [u32;16], b: u16;32     },
            (6, 6, 0x012) => ex!{|s| gt_u a: [u32;16], b: u8;64      },

            // gt_s
            (0, 0, 0x013) => ex!{|s| gt_s a: u8,       b: u8;1       },

            (1, 0, 0x013) => ex!{|s| gt_s a: u16,      b: u16;1      },
            (1, 1, 0x013) => ex!{|s| gt_s a: u16,      b: u8;2       },

            (2, 0, 0x013) => ex!{|s| gt_s a: u32,      b: u32;1      },
            (2, 1, 0x013) => ex!{|s| gt_s a: u32,      b: u16;2      },
            (2, 2, 0x013) => ex!{|s| gt_s a: u32,      b: u8;4       },

            (3, 0, 0x013) => ex!{|s| gt_s a: u64,      b: u64;1      },
            (3, 1, 0x013) => ex!{|s| gt_s a: u64,      b: u32;2      },
            (3, 2, 0x013) => ex!{|s| gt_s a: u64,      b: u16;4      },
            (3, 3, 0x013) => ex!{|s| gt_s a: u64,      b: u8;8       },

            (4, 0, 0x013) => ex!{|s| gt_s a: u128,     b: u128;1     },
            (4, 1, 0x013) => ex!{|s| gt_s a: u128,     b: u64;2      },
            (4, 2, 0x013) => ex!{|s| gt_s a: u128,     b: u32;4      },
            (4, 3, 0x013) => ex!{|s| gt_s a: u128,     b: u16;8      },
            (4, 4, 0x013) => ex!{|s| gt_s a: u128,     b: u8;16      },

            (5, 0, 0x013) => ex!{|s| gt_s a: [u32;8],  b: [u32;8];1  },
            (5, 1, 0x013) => ex!{|s| gt_s a: [u32;8],  b: u128;2     },
            (5, 2, 0x013) => ex!{|s| gt_s a: [u32;8],  b: u64;4      },
            (5, 3, 0x013) => ex!{|s| gt_s a: [u32;8],  b: u32;8      },
            (5, 4, 0x013) => ex!{|s| gt_s a: [u32;8],  b: u16;16     },
            (5, 5, 0x013) => ex!{|s| gt_s a: [u32;8],  b: u8;32      },

            (6, 0, 0x013) => ex!{|s| gt_s a: [u32;16], b: [u32;16];1 },
            (6, 1, 0x013) => ex!{|s| gt_s a: [u32;16], b: [u32;8];2  },
            (6, 2, 0x013) => ex!{|s| gt_s a: [u32;16], b: u128;4     },
            (6, 3, 0x013) => ex!{|s| gt_s a: [u32;16], b: u64;8      },
            (6, 4, 0x013) => ex!{|s| gt_s a: [u32;16], b: u32;16     },
            (6, 5, 0x013) => ex!{|s| gt_s a: [u32;16], b: u16;32     },
            (6, 6, 0x013) => ex!{|s| gt_s a: [u32;16], b: u8;64      },

            // le_u
            (0, 0, 0x014) => ex!{|s| le_u a: u8,       b: u8;1       },

            (1, 0, 0x014) => ex!{|s| le_u a: u16,      b: u16;1      },
            (1, 1, 0x014) => ex!{|s| le_u a: u16,      b: u8;2       },

            (2, 0, 0x014) => ex!{|s| le_u a: u32,      b: u32;1      },
            (2, 1, 0x014) => ex!{|s| le_u a: u32,      b: u16;2      },
            (2, 2, 0x014) => ex!{|s| le_u a: u32,      b: u8;4       },

            (3, 0, 0x014) => ex!{|s| le_u a: u64,      b: u64;1      },
            (3, 1, 0x014) => ex!{|s| le_u a: u64,      b: u32;2      },
            (3, 2, 0x014) => ex!{|s| le_u a: u64,      b: u16;4      },
            (3, 3, 0x014) => ex!{|s| le_u a: u64,      b: u8;8       },

            (4, 0, 0x014) => ex!{|s| le_u a: u128,     b: u128;1     },
            (4, 1, 0x014) => ex!{|s| le_u a: u128,     b: u64;2      },
            (4, 2, 0x014) => ex!{|s| le_u a: u128,     b: u32;4      },
            (4, 3, 0x014) => ex!{|s| le_u a: u128,     b: u16;8      },
            (4, 4, 0x014) => ex!{|s| le_u a: u128,     b: u8;16      },

            (5, 0, 0x014) => ex!{|s| le_u a: [u32;8],  b: [u32;8];1  },
            (5, 1, 0x014) => ex!{|s| le_u a: [u32;8],  b: u128;2     },
            (5, 2, 0x014) => ex!{|s| le_u a: [u32;8],  b: u64;4      },
            (5, 3, 0x014) => ex!{|s| le_u a: [u32;8],  b: u32;8      },
            (5, 4, 0x014) => ex!{|s| le_u a: [u32;8],  b: u16;16     },
            (5, 5, 0x014) => ex!{|s| le_u a: [u32;8],  b: u8;32      },

            (6, 0, 0x014) => ex!{|s| le_u a: [u32;16], b: [u32;16];1 },
            (6, 1, 0x014) => ex!{|s| le_u a: [u32;16], b: [u32;8];2  },
            (6, 2, 0x014) => ex!{|s| le_u a: [u32;16], b: u128;4     },
            (6, 3, 0x014) => ex!{|s| le_u a: [u32;16], b: u64;8      },
            (6, 4, 0x014) => ex!{|s| le_u a: [u32;16], b: u32;16     },
            (6, 5, 0x014) => ex!{|s| le_u a: [u32;16], b: u16;32     },
            (6, 6, 0x014) => ex!{|s| le_u a: [u32;16], b: u8;64      },

            // le_s
            (0, 0, 0x015) => ex!{|s| le_s a: u8,       b: u8;1       },

            (1, 0, 0x015) => ex!{|s| le_s a: u16,      b: u16;1      },
            (1, 1, 0x015) => ex!{|s| le_s a: u16,      b: u8;2       },

            (2, 0, 0x015) => ex!{|s| le_s a: u32,      b: u32;1      },
            (2, 1, 0x015) => ex!{|s| le_s a: u32,      b: u16;2      },
            (2, 2, 0x015) => ex!{|s| le_s a: u32,      b: u8;4       },

            (3, 0, 0x015) => ex!{|s| le_s a: u64,      b: u64;1      },
            (3, 1, 0x015) => ex!{|s| le_s a: u64,      b: u32;2      },
            (3, 2, 0x015) => ex!{|s| le_s a: u64,      b: u16;4      },
            (3, 3, 0x015) => ex!{|s| le_s a: u64,      b: u8;8       },

            (4, 0, 0x015) => ex!{|s| le_s a: u128,     b: u128;1     },
            (4, 1, 0x015) => ex!{|s| le_s a: u128,     b: u64;2      },
            (4, 2, 0x015) => ex!{|s| le_s a: u128,     b: u32;4      },
            (4, 3, 0x015) => ex!{|s| le_s a: u128,     b: u16;8      },
            (4, 4, 0x015) => ex!{|s| le_s a: u128,     b: u8;16      },

            (5, 0, 0x015) => ex!{|s| le_s a: [u32;8],  b: [u32;8];1  },
            (5, 1, 0x015) => ex!{|s| le_s a: [u32;8],  b: u128;2     },
            (5, 2, 0x015) => ex!{|s| le_s a: [u32;8],  b: u64;4      },
            (5, 3, 0x015) => ex!{|s| le_s a: [u32;8],  b: u32;8      },
            (5, 4, 0x015) => ex!{|s| le_s a: [u32;8],  b: u16;16     },
            (5, 5, 0x015) => ex!{|s| le_s a: [u32;8],  b: u8;32      },

            (6, 0, 0x015) => ex!{|s| le_s a: [u32;16], b: [u32;16];1 },
            (6, 1, 0x015) => ex!{|s| le_s a: [u32;16], b: [u32;8];2  },
            (6, 2, 0x015) => ex!{|s| le_s a: [u32;16], b: u128;4     },
            (6, 3, 0x015) => ex!{|s| le_s a: [u32;16], b: u64;8      },
            (6, 4, 0x015) => ex!{|s| le_s a: [u32;16], b: u32;16     },
            (6, 5, 0x015) => ex!{|s| le_s a: [u32;16], b: u16;32     },
            (6, 6, 0x015) => ex!{|s| le_s a: [u32;16], b: u8;64      },

            // ge_u
            (0, 0, 0x016) => ex!{|s| ge_u a: u8,       b: u8;1       },

            (1, 0, 0x016) => ex!{|s| ge_u a: u16,      b: u16;1      },
            (1, 1, 0x016) => ex!{|s| ge_u a: u16,      b: u8;2       },

            (2, 0, 0x016) => ex!{|s| ge_u a: u32,      b: u32;1      },
            (2, 1, 0x016) => ex!{|s| ge_u a: u32,      b: u16;2      },
            (2, 2, 0x016) => ex!{|s| ge_u a: u32,      b: u8;4       },

            (3, 0, 0x016) => ex!{|s| ge_u a: u64,      b: u64;1      },
            (3, 1, 0x016) => ex!{|s| ge_u a: u64,      b: u32;2      },
            (3, 2, 0x016) => ex!{|s| ge_u a: u64,      b: u16;4      },
            (3, 3, 0x016) => ex!{|s| ge_u a: u64,      b: u8;8       },

            (4, 0, 0x016) => ex!{|s| ge_u a: u128,     b: u128;1     },
            (4, 1, 0x016) => ex!{|s| ge_u a: u128,     b: u64;2      },
            (4, 2, 0x016) => ex!{|s| ge_u a: u128,     b: u32;4      },
            (4, 3, 0x016) => ex!{|s| ge_u a: u128,     b: u16;8      },
            (4, 4, 0x016) => ex!{|s| ge_u a: u128,     b: u8;16      },

            (5, 0, 0x016) => ex!{|s| ge_u a: [u32;8],  b: [u32;8];1  },
            (5, 1, 0x016) => ex!{|s| ge_u a: [u32;8],  b: u128;2     },
            (5, 2, 0x016) => ex!{|s| ge_u a: [u32;8],  b: u64;4      },
            (5, 3, 0x016) => ex!{|s| ge_u a: [u32;8],  b: u32;8      },
            (5, 4, 0x016) => ex!{|s| ge_u a: [u32;8],  b: u16;16     },
            (5, 5, 0x016) => ex!{|s| ge_u a: [u32;8],  b: u8;32      },

            (6, 0, 0x016) => ex!{|s| ge_u a: [u32;16], b: [u32;16];1 },
            (6, 1, 0x016) => ex!{|s| ge_u a: [u32;16], b: [u32;8];2  },
            (6, 2, 0x016) => ex!{|s| ge_u a: [u32;16], b: u128;4     },
            (6, 3, 0x016) => ex!{|s| ge_u a: [u32;16], b: u64;8      },
            (6, 4, 0x016) => ex!{|s| ge_u a: [u32;16], b: u32;16     },
            (6, 5, 0x016) => ex!{|s| ge_u a: [u32;16], b: u16;32     },
            (6, 6, 0x016) => ex!{|s| ge_u a: [u32;16], b: u8;64      },

            // ge_s
            (0, 0, 0x017) => ex!{|s| ge_s a: u8,       b: u8;1       },

            (1, 0, 0x017) => ex!{|s| ge_s a: u16,      b: u16;1      },
            (1, 1, 0x017) => ex!{|s| ge_s a: u16,      b: u8;2       },

            (2, 0, 0x017) => ex!{|s| ge_s a: u32,      b: u32;1      },
            (2, 1, 0x017) => ex!{|s| ge_s a: u32,      b: u16;2      },
            (2, 2, 0x017) => ex!{|s| ge_s a: u32,      b: u8;4       },

            (3, 0, 0x017) => ex!{|s| ge_s a: u64,      b: u64;1      },
            (3, 1, 0x017) => ex!{|s| ge_s a: u64,      b: u32;2      },
            (3, 2, 0x017) => ex!{|s| ge_s a: u64,      b: u16;4      },
            (3, 3, 0x017) => ex!{|s| ge_s a: u64,      b: u8;8       },

            (4, 0, 0x017) => ex!{|s| ge_s a: u128,     b: u128;1     },
            (4, 1, 0x017) => ex!{|s| ge_s a: u128,     b: u64;2      },
            (4, 2, 0x017) => ex!{|s| ge_s a: u128,     b: u32;4      },
            (4, 3, 0x017) => ex!{|s| ge_s a: u128,     b: u16;8      },
            (4, 4, 0x017) => ex!{|s| ge_s a: u128,     b: u8;16      },

            (5, 0, 0x017) => ex!{|s| ge_s a: [u32;8],  b: [u32;8];1  },
            (5, 1, 0x017) => ex!{|s| ge_s a: [u32;8],  b: u128;2     },
            (5, 2, 0x017) => ex!{|s| ge_s a: [u32;8],  b: u64;4      },
            (5, 3, 0x017) => ex!{|s| ge_s a: [u32;8],  b: u32;8      },
            (5, 4, 0x017) => ex!{|s| ge_s a: [u32;8],  b: u16;16     },
            (5, 5, 0x017) => ex!{|s| ge_s a: [u32;8],  b: u8;32      },

            (6, 0, 0x017) => ex!{|s| ge_s a: [u32;16], b: [u32;16];1 },
            (6, 1, 0x017) => ex!{|s| ge_s a: [u32;16], b: [u32;8];2  },
            (6, 2, 0x017) => ex!{|s| ge_s a: [u32;16], b: u128;4     },
            (6, 3, 0x017) => ex!{|s| ge_s a: [u32;16], b: u64;8      },
            (6, 4, 0x017) => ex!{|s| ge_s a: [u32;16], b: u32;16     },
            (6, 5, 0x017) => ex!{|s| ge_s a: [u32;16], b: u16;32     },
            (6, 6, 0x017) => ex!{|s| ge_s a: [u32;16], b: u8;64      },

            // min_u
            (0, 0, 0x018) => ex!{|s| min_u a: u8,       b: u8;1       },

            (1, 0, 0x018) => ex!{|s| min_u a: u16,      b: u16;1      },
            (1, 1, 0x018) => ex!{|s| min_u a: u16,      b: u8;2       },

            (2, 0, 0x018) => ex!{|s| min_u a: u32,      b: u32;1      },
            (2, 1, 0x018) => ex!{|s| min_u a: u32,      b: u16;2      },
            (2, 2, 0x018) => ex!{|s| min_u a: u32,      b: u8;4       },

            (3, 0, 0x018) => ex!{|s| min_u a: u64,      b: u64;1      },
            (3, 1, 0x018) => ex!{|s| min_u a: u64,      b: u32;2      },
            (3, 2, 0x018) => ex!{|s| min_u a: u64,      b: u16;4      },
            (3, 3, 0x018) => ex!{|s| min_u a: u64,      b: u8;8       },

            (4, 0, 0x018) => ex!{|s| min_u a: u128,     b: u128;1     },
            (4, 1, 0x018) => ex!{|s| min_u a: u128,     b: u64;2      },
            (4, 2, 0x018) => ex!{|s| min_u a: u128,     b: u32;4      },
            (4, 3, 0x018) => ex!{|s| min_u a: u128,     b: u16;8      },
            (4, 4, 0x018) => ex!{|s| min_u a: u128,     b: u8;16      },

            (5, 0, 0x018) => ex!{|s| min_u a: [u32;8],  b: [u32;8];1  },
            (5, 1, 0x018) => ex!{|s| min_u a: [u32;8],  b: u128;2     },
            (5, 2, 0x018) => ex!{|s| min_u a: [u32;8],  b: u64;4      },
            (5, 3, 0x018) => ex!{|s| min_u a: [u32;8],  b: u32;8      },
            (5, 4, 0x018) => ex!{|s| min_u a: [u32;8],  b: u16;16     },
            (5, 5, 0x018) => ex!{|s| min_u a: [u32;8],  b: u8;32      },

            (6, 0, 0x018) => ex!{|s| min_u a: [u32;16], b: [u32;16];1 },
            (6, 1, 0x018) => ex!{|s| min_u a: [u32;16], b: [u32;8];2  },
            (6, 2, 0x018) => ex!{|s| min_u a: [u32;16], b: u128;4     },
            (6, 3, 0x018) => ex!{|s| min_u a: [u32;16], b: u64;8      },
            (6, 4, 0x018) => ex!{|s| min_u a: [u32;16], b: u32;16     },
            (6, 5, 0x018) => ex!{|s| min_u a: [u32;16], b: u16;32     },
            (6, 6, 0x018) => ex!{|s| min_u a: [u32;16], b: u8;64      },

            // min_s
            (0, 0, 0x019) => ex!{|s| min_s a: u8,       b: u8;1       },

            (1, 0, 0x019) => ex!{|s| min_s a: u16,      b: u16;1      },
            (1, 1, 0x019) => ex!{|s| min_s a: u16,      b: u8;2       },

            (2, 0, 0x019) => ex!{|s| min_s a: u32,      b: u32;1      },
            (2, 1, 0x019) => ex!{|s| min_s a: u32,      b: u16;2      },
            (2, 2, 0x019) => ex!{|s| min_s a: u32,      b: u8;4       },

            (3, 0, 0x019) => ex!{|s| min_s a: u64,      b: u64;1      },
            (3, 1, 0x019) => ex!{|s| min_s a: u64,      b: u32;2      },
            (3, 2, 0x019) => ex!{|s| min_s a: u64,      b: u16;4      },
            (3, 3, 0x019) => ex!{|s| min_s a: u64,      b: u8;8       },

            (4, 0, 0x019) => ex!{|s| min_s a: u128,     b: u128;1     },
            (4, 1, 0x019) => ex!{|s| min_s a: u128,     b: u64;2      },
            (4, 2, 0x019) => ex!{|s| min_s a: u128,     b: u32;4      },
            (4, 3, 0x019) => ex!{|s| min_s a: u128,     b: u16;8      },
            (4, 4, 0x019) => ex!{|s| min_s a: u128,     b: u8;16      },

            (5, 0, 0x019) => ex!{|s| min_s a: [u32;8],  b: [u32;8];1  },
            (5, 1, 0x019) => ex!{|s| min_s a: [u32;8],  b: u128;2     },
            (5, 2, 0x019) => ex!{|s| min_s a: [u32;8],  b: u64;4      },
            (5, 3, 0x019) => ex!{|s| min_s a: [u32;8],  b: u32;8      },
            (5, 4, 0x019) => ex!{|s| min_s a: [u32;8],  b: u16;16     },
            (5, 5, 0x019) => ex!{|s| min_s a: [u32;8],  b: u8;32      },

            (6, 0, 0x019) => ex!{|s| min_s a: [u32;16], b: [u32;16];1 },
            (6, 1, 0x019) => ex!{|s| min_s a: [u32;16], b: [u32;8];2  },
            (6, 2, 0x019) => ex!{|s| min_s a: [u32;16], b: u128;4     },
            (6, 3, 0x019) => ex!{|s| min_s a: [u32;16], b: u64;8      },
            (6, 4, 0x019) => ex!{|s| min_s a: [u32;16], b: u32;16     },
            (6, 5, 0x019) => ex!{|s| min_s a: [u32;16], b: u16;32     },
            (6, 6, 0x019) => ex!{|s| min_s a: [u32;16], b: u8;64      },

            // max_u
            (0, 0, 0x01a) => ex!{|s| max_u a: u8,       b: u8;1       },

            (1, 0, 0x01a) => ex!{|s| max_u a: u16,      b: u16;1      },
            (1, 1, 0x01a) => ex!{|s| max_u a: u16,      b: u8;2       },

            (2, 0, 0x01a) => ex!{|s| max_u a: u32,      b: u32;1      },
            (2, 1, 0x01a) => ex!{|s| max_u a: u32,      b: u16;2      },
            (2, 2, 0x01a) => ex!{|s| max_u a: u32,      b: u8;4       },

            (3, 0, 0x01a) => ex!{|s| max_u a: u64,      b: u64;1      },
            (3, 1, 0x01a) => ex!{|s| max_u a: u64,      b: u32;2      },
            (3, 2, 0x01a) => ex!{|s| max_u a: u64,      b: u16;4      },
            (3, 3, 0x01a) => ex!{|s| max_u a: u64,      b: u8;8       },

            (4, 0, 0x01a) => ex!{|s| max_u a: u128,     b: u128;1     },
            (4, 1, 0x01a) => ex!{|s| max_u a: u128,     b: u64;2      },
            (4, 2, 0x01a) => ex!{|s| max_u a: u128,     b: u32;4      },
            (4, 3, 0x01a) => ex!{|s| max_u a: u128,     b: u16;8      },
            (4, 4, 0x01a) => ex!{|s| max_u a: u128,     b: u8;16      },

            (5, 0, 0x01a) => ex!{|s| max_u a: [u32;8],  b: [u32;8];1  },
            (5, 1, 0x01a) => ex!{|s| max_u a: [u32;8],  b: u128;2     },
            (5, 2, 0x01a) => ex!{|s| max_u a: [u32;8],  b: u64;4      },
            (5, 3, 0x01a) => ex!{|s| max_u a: [u32;8],  b: u32;8      },
            (5, 4, 0x01a) => ex!{|s| max_u a: [u32;8],  b: u16;16     },
            (5, 5, 0x01a) => ex!{|s| max_u a: [u32;8],  b: u8;32      },

            (6, 0, 0x01a) => ex!{|s| max_u a: [u32;16], b: [u32;16];1 },
            (6, 1, 0x01a) => ex!{|s| max_u a: [u32;16], b: [u32;8];2  },
            (6, 2, 0x01a) => ex!{|s| max_u a: [u32;16], b: u128;4     },
            (6, 3, 0x01a) => ex!{|s| max_u a: [u32;16], b: u64;8      },
            (6, 4, 0x01a) => ex!{|s| max_u a: [u32;16], b: u32;16     },
            (6, 5, 0x01a) => ex!{|s| max_u a: [u32;16], b: u16;32     },
            (6, 6, 0x01a) => ex!{|s| max_u a: [u32;16], b: u8;64      },

            // max_s
            (0, 0, 0x01b) => ex!{|s| max_s a: u8,       b: u8;1       },

            (1, 0, 0x01b) => ex!{|s| max_s a: u16,      b: u16;1      },
            (1, 1, 0x01b) => ex!{|s| max_s a: u16,      b: u8;2       },

            (2, 0, 0x01b) => ex!{|s| max_s a: u32,      b: u32;1      },
            (2, 1, 0x01b) => ex!{|s| max_s a: u32,      b: u16;2      },
            (2, 2, 0x01b) => ex!{|s| max_s a: u32,      b: u8;4       },

            (3, 0, 0x01b) => ex!{|s| max_s a: u64,      b: u64;1      },
            (3, 1, 0x01b) => ex!{|s| max_s a: u64,      b: u32;2      },
            (3, 2, 0x01b) => ex!{|s| max_s a: u64,      b: u16;4      },
            (3, 3, 0x01b) => ex!{|s| max_s a: u64,      b: u8;8       },

            (4, 0, 0x01b) => ex!{|s| max_s a: u128,     b: u128;1     },
            (4, 1, 0x01b) => ex!{|s| max_s a: u128,     b: u64;2      },
            (4, 2, 0x01b) => ex!{|s| max_s a: u128,     b: u32;4      },
            (4, 3, 0x01b) => ex!{|s| max_s a: u128,     b: u16;8      },
            (4, 4, 0x01b) => ex!{|s| max_s a: u128,     b: u8;16      },

            (5, 0, 0x01b) => ex!{|s| max_s a: [u32;8],  b: [u32;8];1  },
            (5, 1, 0x01b) => ex!{|s| max_s a: [u32;8],  b: u128;2     },
            (5, 2, 0x01b) => ex!{|s| max_s a: [u32;8],  b: u64;4      },
            (5, 3, 0x01b) => ex!{|s| max_s a: [u32;8],  b: u32;8      },
            (5, 4, 0x01b) => ex!{|s| max_s a: [u32;8],  b: u16;16     },
            (5, 5, 0x01b) => ex!{|s| max_s a: [u32;8],  b: u8;32      },

            (6, 0, 0x01b) => ex!{|s| max_s a: [u32;16], b: [u32;16];1 },
            (6, 1, 0x01b) => ex!{|s| max_s a: [u32;16], b: [u32;8];2  },
            (6, 2, 0x01b) => ex!{|s| max_s a: [u32;16], b: u128;4     },
            (6, 3, 0x01b) => ex!{|s| max_s a: [u32;16], b: u64;8      },
            (6, 4, 0x01b) => ex!{|s| max_s a: [u32;16], b: u32;16     },
            (6, 5, 0x01b) => ex!{|s| max_s a: [u32;16], b: u16;32     },
            (6, 6, 0x01b) => ex!{|s| max_s a: [u32;16], b: u8;64      },


            //// integer instructions ////

            // neg
            (0, 0, 0x01c) => ex!{|s| neg a: u8,       b: u8;1       },

            (1, 0, 0x01c) => ex!{|s| neg a: u16,      b: u16;1      },
            (1, 1, 0x01c) => ex!{|s| neg a: u16,      b: u8;2       },

            (2, 0, 0x01c) => ex!{|s| neg a: u32,      b: u32;1      },
            (2, 1, 0x01c) => ex!{|s| neg a: u32,      b: u16;2      },
            (2, 2, 0x01c) => ex!{|s| neg a: u32,      b: u8;4       },

            (3, 0, 0x01c) => ex!{|s| neg a: u64,      b: u64;1      },
            (3, 1, 0x01c) => ex!{|s| neg a: u64,      b: u32;2      },
            (3, 2, 0x01c) => ex!{|s| neg a: u64,      b: u16;4      },
            (3, 3, 0x01c) => ex!{|s| neg a: u64,      b: u8;8       },

            (4, 0, 0x01c) => ex!{|s| neg a: u128,     b: u128;1     },
            (4, 1, 0x01c) => ex!{|s| neg a: u128,     b: u64;2      },
            (4, 2, 0x01c) => ex!{|s| neg a: u128,     b: u32;4      },
            (4, 3, 0x01c) => ex!{|s| neg a: u128,     b: u16;8      },
            (4, 4, 0x01c) => ex!{|s| neg a: u128,     b: u8;16      },

            (5, 0, 0x01c) => ex!{|s| neg a: [u32;8],  b: [u32;8];1  },
            (5, 1, 0x01c) => ex!{|s| neg a: [u32;8],  b: u128;2     },
            (5, 2, 0x01c) => ex!{|s| neg a: [u32;8],  b: u64;4      },
            (5, 3, 0x01c) => ex!{|s| neg a: [u32;8],  b: u32;8      },
            (5, 4, 0x01c) => ex!{|s| neg a: [u32;8],  b: u16;16     },
            (5, 5, 0x01c) => ex!{|s| neg a: [u32;8],  b: u8;32      },

            (6, 0, 0x01c) => ex!{|s| neg a: [u32;16], b: [u32;16];1 },
            (6, 1, 0x01c) => ex!{|s| neg a: [u32;16], b: [u32;8];2  },
            (6, 2, 0x01c) => ex!{|s| neg a: [u32;16], b: u128;4     },
            (6, 3, 0x01c) => ex!{|s| neg a: [u32;16], b: u64;8      },
            (6, 4, 0x01c) => ex!{|s| neg a: [u32;16], b: u32;16     },
            (6, 5, 0x01c) => ex!{|s| neg a: [u32;16], b: u16;32     },
            (6, 6, 0x01c) => ex!{|s| neg a: [u32;16], b: u8;64      },

            // abs
            (0, 0, 0x01d) => ex!{|s| abs a: u8,       b: u8;1       },

            (1, 0, 0x01d) => ex!{|s| abs a: u16,      b: u16;1      },
            (1, 1, 0x01d) => ex!{|s| abs a: u16,      b: u8;2       },

            (2, 0, 0x01d) => ex!{|s| abs a: u32,      b: u32;1      },
            (2, 1, 0x01d) => ex!{|s| abs a: u32,      b: u16;2      },
            (2, 2, 0x01d) => ex!{|s| abs a: u32,      b: u8;4       },

            (3, 0, 0x01d) => ex!{|s| abs a: u64,      b: u64;1      },
            (3, 1, 0x01d) => ex!{|s| abs a: u64,      b: u32;2      },
            (3, 2, 0x01d) => ex!{|s| abs a: u64,      b: u16;4      },
            (3, 3, 0x01d) => ex!{|s| abs a: u64,      b: u8;8       },

            (4, 0, 0x01d) => ex!{|s| abs a: u128,     b: u128;1     },
            (4, 1, 0x01d) => ex!{|s| abs a: u128,     b: u64;2      },
            (4, 2, 0x01d) => ex!{|s| abs a: u128,     b: u32;4      },
            (4, 3, 0x01d) => ex!{|s| abs a: u128,     b: u16;8      },
            (4, 4, 0x01d) => ex!{|s| abs a: u128,     b: u8;16      },

            (5, 0, 0x01d) => ex!{|s| abs a: [u32;8],  b: [u32;8];1  },
            (5, 1, 0x01d) => ex!{|s| abs a: [u32;8],  b: u128;2     },
            (5, 2, 0x01d) => ex!{|s| abs a: [u32;8],  b: u64;4      },
            (5, 3, 0x01d) => ex!{|s| abs a: [u32;8],  b: u32;8      },
            (5, 4, 0x01d) => ex!{|s| abs a: [u32;8],  b: u16;16     },
            (5, 5, 0x01d) => ex!{|s| abs a: [u32;8],  b: u8;32      },

            (6, 0, 0x01d) => ex!{|s| abs a: [u32;16], b: [u32;16];1 },
            (6, 1, 0x01d) => ex!{|s| abs a: [u32;16], b: [u32;8];2  },
            (6, 2, 0x01d) => ex!{|s| abs a: [u32;16], b: u128;4     },
            (6, 3, 0x01d) => ex!{|s| abs a: [u32;16], b: u64;8      },
            (6, 4, 0x01d) => ex!{|s| abs a: [u32;16], b: u32;16     },
            (6, 5, 0x01d) => ex!{|s| abs a: [u32;16], b: u16;32     },
            (6, 6, 0x01d) => ex!{|s| abs a: [u32;16], b: u8;64      },

            // not
            (0, 0..=0, 0x01e) => ex!{|s| not a: u8,       b: u8       },
            (1, 0..=1, 0x01e) => ex!{|s| not a: u16,      b: u16      },
            (2, 0..=2, 0x01e) => ex!{|s| not a: u32,      b: u32      },
            (3, 0..=3, 0x01e) => ex!{|s| not a: u64,      b: u64      },
            (4, 0..=4, 0x01e) => ex!{|s| not a: u128,     b: u128     },
            (5, 0..=5, 0x01e) => ex!{|s| not a: [u32;8],  b: [u32;8]  },
            (6, 0..=6, 0x01e) => ex!{|s| not a: [u32;16], b: [u32;16] },

            // clz
            (0, 0, 0x01f) => ex!{|s| clz a: u8,       b: u8;1       },

            (1, 0, 0x01f) => ex!{|s| clz a: u16,      b: u16;1      },
            (1, 1, 0x01f) => ex!{|s| clz a: u16,      b: u8;2       },

            (2, 0, 0x01f) => ex!{|s| clz a: u32,      b: u32;1      },
            (2, 1, 0x01f) => ex!{|s| clz a: u32,      b: u16;2      },
            (2, 2, 0x01f) => ex!{|s| clz a: u32,      b: u8;4       },

            (3, 0, 0x01f) => ex!{|s| clz a: u64,      b: u64;1      },
            (3, 1, 0x01f) => ex!{|s| clz a: u64,      b: u32;2      },
            (3, 2, 0x01f) => ex!{|s| clz a: u64,      b: u16;4      },
            (3, 3, 0x01f) => ex!{|s| clz a: u64,      b: u8;8       },

            (4, 0, 0x01f) => ex!{|s| clz a: u128,     b: u128;1     },
            (4, 1, 0x01f) => ex!{|s| clz a: u128,     b: u64;2      },
            (4, 2, 0x01f) => ex!{|s| clz a: u128,     b: u32;4      },
            (4, 3, 0x01f) => ex!{|s| clz a: u128,     b: u16;8      },
            (4, 4, 0x01f) => ex!{|s| clz a: u128,     b: u8;16      },

            (5, 0, 0x01f) => ex!{|s| clz a: [u32;8],  b: [u32;8];1  },
            (5, 1, 0x01f) => ex!{|s| clz a: [u32;8],  b: u128;2     },
            (5, 2, 0x01f) => ex!{|s| clz a: [u32;8],  b: u64;4      },
            (5, 3, 0x01f) => ex!{|s| clz a: [u32;8],  b: u32;8      },
            (5, 4, 0x01f) => ex!{|s| clz a: [u32;8],  b: u16;16     },
            (5, 5, 0x01f) => ex!{|s| clz a: [u32;8],  b: u8;32      },

            (6, 0, 0x01f) => ex!{|s| clz a: [u32;16], b: [u32;16];1 },
            (6, 1, 0x01f) => ex!{|s| clz a: [u32;16], b: [u32;8];2  },
            (6, 2, 0x01f) => ex!{|s| clz a: [u32;16], b: u128;4     },
            (6, 3, 0x01f) => ex!{|s| clz a: [u32;16], b: u64;8      },
            (6, 4, 0x01f) => ex!{|s| clz a: [u32;16], b: u32;16     },
            (6, 5, 0x01f) => ex!{|s| clz a: [u32;16], b: u16;32     },
            (6, 6, 0x01f) => ex!{|s| clz a: [u32;16], b: u8;64      },

            // ctz
            (0, 0, 0x020) => ex!{|s| ctz a: u8,       b: u8;1       },

            (1, 0, 0x020) => ex!{|s| ctz a: u16,      b: u16;1      },
            (1, 1, 0x020) => ex!{|s| ctz a: u16,      b: u8;2       },

            (2, 0, 0x020) => ex!{|s| ctz a: u32,      b: u32;1      },
            (2, 1, 0x020) => ex!{|s| ctz a: u32,      b: u16;2      },
            (2, 2, 0x020) => ex!{|s| ctz a: u32,      b: u8;4       },

            (3, 0, 0x020) => ex!{|s| ctz a: u64,      b: u64;1      },
            (3, 1, 0x020) => ex!{|s| ctz a: u64,      b: u32;2      },
            (3, 2, 0x020) => ex!{|s| ctz a: u64,      b: u16;4      },
            (3, 3, 0x020) => ex!{|s| ctz a: u64,      b: u8;8       },

            (4, 0, 0x020) => ex!{|s| ctz a: u128,     b: u128;1     },
            (4, 1, 0x020) => ex!{|s| ctz a: u128,     b: u64;2      },
            (4, 2, 0x020) => ex!{|s| ctz a: u128,     b: u32;4      },
            (4, 3, 0x020) => ex!{|s| ctz a: u128,     b: u16;8      },
            (4, 4, 0x020) => ex!{|s| ctz a: u128,     b: u8;16      },

            (5, 0, 0x020) => ex!{|s| ctz a: [u32;8],  b: [u32;8];1  },
            (5, 1, 0x020) => ex!{|s| ctz a: [u32;8],  b: u128;2     },
            (5, 2, 0x020) => ex!{|s| ctz a: [u32;8],  b: u64;4      },
            (5, 3, 0x020) => ex!{|s| ctz a: [u32;8],  b: u32;8      },
            (5, 4, 0x020) => ex!{|s| ctz a: [u32;8],  b: u16;16     },
            (5, 5, 0x020) => ex!{|s| ctz a: [u32;8],  b: u8;32      },

            (6, 0, 0x020) => ex!{|s| ctz a: [u32;16], b: [u32;16];1 },
            (6, 1, 0x020) => ex!{|s| ctz a: [u32;16], b: [u32;8];2  },
            (6, 2, 0x020) => ex!{|s| ctz a: [u32;16], b: u128;4     },
            (6, 3, 0x020) => ex!{|s| ctz a: [u32;16], b: u64;8      },
            (6, 4, 0x020) => ex!{|s| ctz a: [u32;16], b: u32;16     },
            (6, 5, 0x020) => ex!{|s| ctz a: [u32;16], b: u16;32     },
            (6, 6, 0x020) => ex!{|s| ctz a: [u32;16], b: u8;64      },

            // popcnt
            (0, 0, 0x021) => ex!{|s| popcnt a: u8,       b: u8;1       },

            (1, 0, 0x021) => ex!{|s| popcnt a: u16,      b: u16;1      },
            (1, 1, 0x021) => ex!{|s| popcnt a: u16,      b: u8;2       },

            (2, 0, 0x021) => ex!{|s| popcnt a: u32,      b: u32;1      },
            (2, 1, 0x021) => ex!{|s| popcnt a: u32,      b: u16;2      },
            (2, 2, 0x021) => ex!{|s| popcnt a: u32,      b: u8;4       },

            (3, 0, 0x021) => ex!{|s| popcnt a: u64,      b: u64;1      },
            (3, 1, 0x021) => ex!{|s| popcnt a: u64,      b: u32;2      },
            (3, 2, 0x021) => ex!{|s| popcnt a: u64,      b: u16;4      },
            (3, 3, 0x021) => ex!{|s| popcnt a: u64,      b: u8;8       },

            (4, 0, 0x021) => ex!{|s| popcnt a: u128,     b: u128;1     },
            (4, 1, 0x021) => ex!{|s| popcnt a: u128,     b: u64;2      },
            (4, 2, 0x021) => ex!{|s| popcnt a: u128,     b: u32;4      },
            (4, 3, 0x021) => ex!{|s| popcnt a: u128,     b: u16;8      },
            (4, 4, 0x021) => ex!{|s| popcnt a: u128,     b: u8;16      },

            (5, 0, 0x021) => ex!{|s| popcnt a: [u32;8],  b: [u32;8];1  },
            (5, 1, 0x021) => ex!{|s| popcnt a: [u32;8],  b: u128;2     },
            (5, 2, 0x021) => ex!{|s| popcnt a: [u32;8],  b: u64;4      },
            (5, 3, 0x021) => ex!{|s| popcnt a: [u32;8],  b: u32;8      },
            (5, 4, 0x021) => ex!{|s| popcnt a: [u32;8],  b: u16;16     },
            (5, 5, 0x021) => ex!{|s| popcnt a: [u32;8],  b: u8;32      },

            (6, 0, 0x021) => ex!{|s| popcnt a: [u32;16], b: [u32;16];1 },
            (6, 1, 0x021) => ex!{|s| popcnt a: [u32;16], b: [u32;8];2  },
            (6, 2, 0x021) => ex!{|s| popcnt a: [u32;16], b: u128;4     },
            (6, 3, 0x021) => ex!{|s| popcnt a: [u32;16], b: u64;8      },
            (6, 4, 0x021) => ex!{|s| popcnt a: [u32;16], b: u32;16     },
            (6, 5, 0x021) => ex!{|s| popcnt a: [u32;16], b: u16;32     },
            (6, 6, 0x021) => ex!{|s| popcnt a: [u32;16], b: u8;64      },

            // add
            (0, 0, 0x022) => ex!{|s| add a: u8,       b: u8;1       },

            (1, 0, 0x022) => ex!{|s| add a: u16,      b: u16;1      },
            (1, 1, 0x022) => ex!{|s| add a: u16,      b: u8;2       },

            (2, 0, 0x022) => ex!{|s| add a: u32,      b: u32;1      },
            (2, 1, 0x022) => ex!{|s| add a: u32,      b: u16;2      },
            (2, 2, 0x022) => ex!{|s| add a: u32,      b: u8;4       },

            (3, 0, 0x022) => ex!{|s| add a: u64,      b: u64;1      },
            (3, 1, 0x022) => ex!{|s| add a: u64,      b: u32;2      },
            (3, 2, 0x022) => ex!{|s| add a: u64,      b: u16;4      },
            (3, 3, 0x022) => ex!{|s| add a: u64,      b: u8;8       },

            (4, 0, 0x022) => ex!{|s| add a: u128,     b: u128;1     },
            (4, 1, 0x022) => ex!{|s| add a: u128,     b: u64;2      },
            (4, 2, 0x022) => ex!{|s| add a: u128,     b: u32;4      },
            (4, 3, 0x022) => ex!{|s| add a: u128,     b: u16;8      },
            (4, 4, 0x022) => ex!{|s| add a: u128,     b: u8;16      },

            (5, 0, 0x022) => ex!{|s| add a: [u32;8],  b: [u32;8];1  },
            (5, 1, 0x022) => ex!{|s| add a: [u32;8],  b: u128;2     },
            (5, 2, 0x022) => ex!{|s| add a: [u32;8],  b: u64;4      },
            (5, 3, 0x022) => ex!{|s| add a: [u32;8],  b: u32;8      },
            (5, 4, 0x022) => ex!{|s| add a: [u32;8],  b: u16;16     },
            (5, 5, 0x022) => ex!{|s| add a: [u32;8],  b: u8;32      },

            (6, 0, 0x022) => ex!{|s| add a: [u32;16], b: [u32;16];1 },
            (6, 1, 0x022) => ex!{|s| add a: [u32;16], b: [u32;8];2  },
            (6, 2, 0x022) => ex!{|s| add a: [u32;16], b: u128;4     },
            (6, 3, 0x022) => ex!{|s| add a: [u32;16], b: u64;8      },
            (6, 4, 0x022) => ex!{|s| add a: [u32;16], b: u32;16     },
            (6, 5, 0x022) => ex!{|s| add a: [u32;16], b: u16;32     },
            (6, 6, 0x022) => ex!{|s| add a: [u32;16], b: u8;64      },

            // sub
            (0, 0, 0x023) => ex!{|s| sub a: u8,       b: u8;1       },

            (1, 0, 0x023) => ex!{|s| sub a: u16,      b: u16;1      },
            (1, 1, 0x023) => ex!{|s| sub a: u16,      b: u8;2       },

            (2, 0, 0x023) => ex!{|s| sub a: u32,      b: u32;1      },
            (2, 1, 0x023) => ex!{|s| sub a: u32,      b: u16;2      },
            (2, 2, 0x023) => ex!{|s| sub a: u32,      b: u8;4       },

            (3, 0, 0x023) => ex!{|s| sub a: u64,      b: u64;1      },
            (3, 1, 0x023) => ex!{|s| sub a: u64,      b: u32;2      },
            (3, 2, 0x023) => ex!{|s| sub a: u64,      b: u16;4      },
            (3, 3, 0x023) => ex!{|s| sub a: u64,      b: u8;8       },

            (4, 0, 0x023) => ex!{|s| sub a: u128,     b: u128;1     },
            (4, 1, 0x023) => ex!{|s| sub a: u128,     b: u64;2      },
            (4, 2, 0x023) => ex!{|s| sub a: u128,     b: u32;4      },
            (4, 3, 0x023) => ex!{|s| sub a: u128,     b: u16;8      },
            (4, 4, 0x023) => ex!{|s| sub a: u128,     b: u8;16      },

            (5, 0, 0x023) => ex!{|s| sub a: [u32;8],  b: [u32;8];1  },
            (5, 1, 0x023) => ex!{|s| sub a: [u32;8],  b: u128;2     },
            (5, 2, 0x023) => ex!{|s| sub a: [u32;8],  b: u64;4      },
            (5, 3, 0x023) => ex!{|s| sub a: [u32;8],  b: u32;8      },
            (5, 4, 0x023) => ex!{|s| sub a: [u32;8],  b: u16;16     },
            (5, 5, 0x023) => ex!{|s| sub a: [u32;8],  b: u8;32      },

            (6, 0, 0x023) => ex!{|s| sub a: [u32;16], b: [u32;16];1 },
            (6, 1, 0x023) => ex!{|s| sub a: [u32;16], b: [u32;8];2  },
            (6, 2, 0x023) => ex!{|s| sub a: [u32;16], b: u128;4     },
            (6, 3, 0x023) => ex!{|s| sub a: [u32;16], b: u64;8      },
            (6, 4, 0x023) => ex!{|s| sub a: [u32;16], b: u32;16     },
            (6, 5, 0x023) => ex!{|s| sub a: [u32;16], b: u16;32     },
            (6, 6, 0x023) => ex!{|s| sub a: [u32;16], b: u8;64      },

            // mul
            (0, 0, 0x024) => ex!{|s| mul a: u8,       b: u8;1       },

            (1, 0, 0x024) => ex!{|s| mul a: u16,      b: u16;1      },
            (1, 1, 0x024) => ex!{|s| mul a: u16,      b: u8;2       },

            (2, 0, 0x024) => ex!{|s| mul a: u32,      b: u32;1      },
            (2, 1, 0x024) => ex!{|s| mul a: u32,      b: u16;2      },
            (2, 2, 0x024) => ex!{|s| mul a: u32,      b: u8;4       },

            (3, 0, 0x024) => ex!{|s| mul a: u64,      b: u64;1      },
            (3, 1, 0x024) => ex!{|s| mul a: u64,      b: u32;2      },
            (3, 2, 0x024) => ex!{|s| mul a: u64,      b: u16;4      },
            (3, 3, 0x024) => ex!{|s| mul a: u64,      b: u8;8       },

            (4, 0, 0x024) => ex!{|s| mul a: u128,     b: u128;1     },
            (4, 1, 0x024) => ex!{|s| mul a: u128,     b: u64;2      },
            (4, 2, 0x024) => ex!{|s| mul a: u128,     b: u32;4      },
            (4, 3, 0x024) => ex!{|s| mul a: u128,     b: u16;8      },
            (4, 4, 0x024) => ex!{|s| mul a: u128,     b: u8;16      },

            (5, 0, 0x024) => ex!{|s| mul a: [u32;8],  b: [u32;8];1  },
            (5, 1, 0x024) => ex!{|s| mul a: [u32;8],  b: u128;2     },
            (5, 2, 0x024) => ex!{|s| mul a: [u32;8],  b: u64;4      },
            (5, 3, 0x024) => ex!{|s| mul a: [u32;8],  b: u32;8      },
            (5, 4, 0x024) => ex!{|s| mul a: [u32;8],  b: u16;16     },
            (5, 5, 0x024) => ex!{|s| mul a: [u32;8],  b: u8;32      },

            (6, 0, 0x024) => ex!{|s| mul a: [u32;16], b: [u32;16];1 },
            (6, 1, 0x024) => ex!{|s| mul a: [u32;16], b: [u32;8];2  },
            (6, 2, 0x024) => ex!{|s| mul a: [u32;16], b: u128;4     },
            (6, 3, 0x024) => ex!{|s| mul a: [u32;16], b: u64;8      },
            (6, 4, 0x024) => ex!{|s| mul a: [u32;16], b: u32;16     },
            (6, 5, 0x024) => ex!{|s| mul a: [u32;16], b: u16;32     },
            (6, 6, 0x024) => ex!{|s| mul a: [u32;16], b: u8;64      },

            // and
            (0, 0..=0, 0x025) => ex!{|s| and a: u8,       b: u8       },
            (1, 0..=1, 0x025) => ex!{|s| and a: u16,      b: u16      },
            (2, 0..=2, 0x025) => ex!{|s| and a: u32,      b: u32      },
            (3, 0..=3, 0x025) => ex!{|s| and a: u64,      b: u64      },
            (4, 0..=4, 0x025) => ex!{|s| and a: u128,     b: u128     },
            (5, 0..=5, 0x025) => ex!{|s| and a: [u32;8],  b: [u32;8]  },
            (6, 0..=6, 0x025) => ex!{|s| and a: [u32;16], b: [u32;16] },

            // andnot
            (0, 0..=0, 0x026) => ex!{|s| andnot a: u8,       b: u8       },
            (1, 0..=1, 0x026) => ex!{|s| andnot a: u16,      b: u16      },
            (2, 0..=2, 0x026) => ex!{|s| andnot a: u32,      b: u32      },
            (3, 0..=3, 0x026) => ex!{|s| andnot a: u64,      b: u64      },
            (4, 0..=4, 0x026) => ex!{|s| andnot a: u128,     b: u128     },
            (5, 0..=5, 0x026) => ex!{|s| andnot a: [u32;8],  b: [u32;8]  },
            (6, 0..=6, 0x026) => ex!{|s| andnot a: [u32;16], b: [u32;16] },

            // or
            (0, 0..=0, 0x027) => ex!{|s| or a: u8,       b: u8       },
            (1, 0..=1, 0x027) => ex!{|s| or a: u16,      b: u16      },
            (2, 0..=2, 0x027) => ex!{|s| or a: u32,      b: u32      },
            (3, 0..=3, 0x027) => ex!{|s| or a: u64,      b: u64      },
            (4, 0..=4, 0x027) => ex!{|s| or a: u128,     b: u128     },
            (5, 0..=5, 0x027) => ex!{|s| or a: [u32;8],  b: [u32;8]  },
            (6, 0..=6, 0x027) => ex!{|s| or a: [u32;16], b: [u32;16] },

            // xor
            (0, 0..=0, 0x028) => ex!{|s| xor a: u8,       b: u8       },
            (1, 0..=1, 0x028) => ex!{|s| xor a: u16,      b: u16      },
            (2, 0..=2, 0x028) => ex!{|s| xor a: u32,      b: u32      },
            (3, 0..=3, 0x028) => ex!{|s| xor a: u64,      b: u64      },
            (4, 0..=4, 0x028) => ex!{|s| xor a: u128,     b: u128     },
            (5, 0..=5, 0x028) => ex!{|s| xor a: [u32;8],  b: [u32;8]  },
            (6, 0..=6, 0x028) => ex!{|s| xor a: [u32;16], b: [u32;16] },

            // shl
            (0, 0, 0x029) => ex!{|s| shl a: u8,       b: u8;1       },

            (1, 0, 0x029) => ex!{|s| shl a: u16,      b: u16;1      },
            (1, 1, 0x029) => ex!{|s| shl a: u16,      b: u8;2       },

            (2, 0, 0x029) => ex!{|s| shl a: u32,      b: u32;1      },
            (2, 1, 0x029) => ex!{|s| shl a: u32,      b: u16;2      },
            (2, 2, 0x029) => ex!{|s| shl a: u32,      b: u8;4       },

            (3, 0, 0x029) => ex!{|s| shl a: u64,      b: u64;1      },
            (3, 1, 0x029) => ex!{|s| shl a: u64,      b: u32;2      },
            (3, 2, 0x029) => ex!{|s| shl a: u64,      b: u16;4      },
            (3, 3, 0x029) => ex!{|s| shl a: u64,      b: u8;8       },

            (4, 0, 0x029) => ex!{|s| shl a: u128,     b: u128;1     },
            (4, 1, 0x029) => ex!{|s| shl a: u128,     b: u64;2      },
            (4, 2, 0x029) => ex!{|s| shl a: u128,     b: u32;4      },
            (4, 3, 0x029) => ex!{|s| shl a: u128,     b: u16;8      },
            (4, 4, 0x029) => ex!{|s| shl a: u128,     b: u8;16      },

            (5, 0, 0x029) => ex!{|s| shl a: [u32;8],  b: [u32;8];1  },
            (5, 1, 0x029) => ex!{|s| shl a: [u32;8],  b: u128;2     },
            (5, 2, 0x029) => ex!{|s| shl a: [u32;8],  b: u64;4      },
            (5, 3, 0x029) => ex!{|s| shl a: [u32;8],  b: u32;8      },
            (5, 4, 0x029) => ex!{|s| shl a: [u32;8],  b: u16;16     },
            (5, 5, 0x029) => ex!{|s| shl a: [u32;8],  b: u8;32      },

            (6, 0, 0x029) => ex!{|s| shl a: [u32;16], b: [u32;16];1 },
            (6, 1, 0x029) => ex!{|s| shl a: [u32;16], b: [u32;8];2  },
            (6, 2, 0x029) => ex!{|s| shl a: [u32;16], b: u128;4     },
            (6, 3, 0x029) => ex!{|s| shl a: [u32;16], b: u64;8      },
            (6, 4, 0x029) => ex!{|s| shl a: [u32;16], b: u32;16     },
            (6, 5, 0x029) => ex!{|s| shl a: [u32;16], b: u16;32     },
            (6, 6, 0x029) => ex!{|s| shl a: [u32;16], b: u8;64      },

            // shr_u
            (0, 0, 0x02a) => ex!{|s| shr_u a: u8,       b: u8;1       },

            (1, 0, 0x02a) => ex!{|s| shr_u a: u16,      b: u16;1      },
            (1, 1, 0x02a) => ex!{|s| shr_u a: u16,      b: u8;2       },

            (2, 0, 0x02a) => ex!{|s| shr_u a: u32,      b: u32;1      },
            (2, 1, 0x02a) => ex!{|s| shr_u a: u32,      b: u16;2      },
            (2, 2, 0x02a) => ex!{|s| shr_u a: u32,      b: u8;4       },

            (3, 0, 0x02a) => ex!{|s| shr_u a: u64,      b: u64;1      },
            (3, 1, 0x02a) => ex!{|s| shr_u a: u64,      b: u32;2      },
            (3, 2, 0x02a) => ex!{|s| shr_u a: u64,      b: u16;4      },
            (3, 3, 0x02a) => ex!{|s| shr_u a: u64,      b: u8;8       },

            (4, 0, 0x02a) => ex!{|s| shr_u a: u128,     b: u128;1     },
            (4, 1, 0x02a) => ex!{|s| shr_u a: u128,     b: u64;2      },
            (4, 2, 0x02a) => ex!{|s| shr_u a: u128,     b: u32;4      },
            (4, 3, 0x02a) => ex!{|s| shr_u a: u128,     b: u16;8      },
            (4, 4, 0x02a) => ex!{|s| shr_u a: u128,     b: u8;16      },

            (5, 0, 0x02a) => ex!{|s| shr_u a: [u32;8],  b: [u32;8];1  },
            (5, 1, 0x02a) => ex!{|s| shr_u a: [u32;8],  b: u128;2     },
            (5, 2, 0x02a) => ex!{|s| shr_u a: [u32;8],  b: u64;4      },
            (5, 3, 0x02a) => ex!{|s| shr_u a: [u32;8],  b: u32;8      },
            (5, 4, 0x02a) => ex!{|s| shr_u a: [u32;8],  b: u16;16     },
            (5, 5, 0x02a) => ex!{|s| shr_u a: [u32;8],  b: u8;32      },

            (6, 0, 0x02a) => ex!{|s| shr_u a: [u32;16], b: [u32;16];1 },
            (6, 1, 0x02a) => ex!{|s| shr_u a: [u32;16], b: [u32;8];2  },
            (6, 2, 0x02a) => ex!{|s| shr_u a: [u32;16], b: u128;4     },
            (6, 3, 0x02a) => ex!{|s| shr_u a: [u32;16], b: u64;8      },
            (6, 4, 0x02a) => ex!{|s| shr_u a: [u32;16], b: u32;16     },
            (6, 5, 0x02a) => ex!{|s| shr_u a: [u32;16], b: u16;32     },
            (6, 6, 0x02a) => ex!{|s| shr_u a: [u32;16], b: u8;64      },

            // shr_s
            (0, 0, 0x02b) => ex!{|s| shr_s a: u8,       b: u8;1       },

            (1, 0, 0x02b) => ex!{|s| shr_s a: u16,      b: u16;1      },
            (1, 1, 0x02b) => ex!{|s| shr_s a: u16,      b: u8;2       },

            (2, 0, 0x02b) => ex!{|s| shr_s a: u32,      b: u32;1      },
            (2, 1, 0x02b) => ex!{|s| shr_s a: u32,      b: u16;2      },
            (2, 2, 0x02b) => ex!{|s| shr_s a: u32,      b: u8;4       },

            (3, 0, 0x02b) => ex!{|s| shr_s a: u64,      b: u64;1      },
            (3, 1, 0x02b) => ex!{|s| shr_s a: u64,      b: u32;2      },
            (3, 2, 0x02b) => ex!{|s| shr_s a: u64,      b: u16;4      },
            (3, 3, 0x02b) => ex!{|s| shr_s a: u64,      b: u8;8       },

            (4, 0, 0x02b) => ex!{|s| shr_s a: u128,     b: u128;1     },
            (4, 1, 0x02b) => ex!{|s| shr_s a: u128,     b: u64;2      },
            (4, 2, 0x02b) => ex!{|s| shr_s a: u128,     b: u32;4      },
            (4, 3, 0x02b) => ex!{|s| shr_s a: u128,     b: u16;8      },
            (4, 4, 0x02b) => ex!{|s| shr_s a: u128,     b: u8;16      },

            (5, 0, 0x02b) => ex!{|s| shr_s a: [u32;8],  b: [u32;8];1  },
            (5, 1, 0x02b) => ex!{|s| shr_s a: [u32;8],  b: u128;2     },
            (5, 2, 0x02b) => ex!{|s| shr_s a: [u32;8],  b: u64;4      },
            (5, 3, 0x02b) => ex!{|s| shr_s a: [u32;8],  b: u32;8      },
            (5, 4, 0x02b) => ex!{|s| shr_s a: [u32;8],  b: u16;16     },
            (5, 5, 0x02b) => ex!{|s| shr_s a: [u32;8],  b: u8;32      },

            (6, 0, 0x02b) => ex!{|s| shr_s a: [u32;16], b: [u32;16];1 },
            (6, 1, 0x02b) => ex!{|s| shr_s a: [u32;16], b: [u32;8];2  },
            (6, 2, 0x02b) => ex!{|s| shr_s a: [u32;16], b: u128;4     },
            (6, 3, 0x02b) => ex!{|s| shr_s a: [u32;16], b: u64;8      },
            (6, 4, 0x02b) => ex!{|s| shr_s a: [u32;16], b: u32;16     },
            (6, 5, 0x02b) => ex!{|s| shr_s a: [u32;16], b: u16;32     },
            (6, 6, 0x02b) => ex!{|s| shr_s a: [u32;16], b: u8;64      },

            // rotl
            (0, 0, 0x02c) => ex!{|s| rotl a: u8,       b: u8;1       },

            (1, 0, 0x02c) => ex!{|s| rotl a: u16,      b: u16;1      },
            (1, 1, 0x02c) => ex!{|s| rotl a: u16,      b: u8;2       },

            (2, 0, 0x02c) => ex!{|s| rotl a: u32,      b: u32;1      },
            (2, 1, 0x02c) => ex!{|s| rotl a: u32,      b: u16;2      },
            (2, 2, 0x02c) => ex!{|s| rotl a: u32,      b: u8;4       },

            (3, 0, 0x02c) => ex!{|s| rotl a: u64,      b: u64;1      },
            (3, 1, 0x02c) => ex!{|s| rotl a: u64,      b: u32;2      },
            (3, 2, 0x02c) => ex!{|s| rotl a: u64,      b: u16;4      },
            (3, 3, 0x02c) => ex!{|s| rotl a: u64,      b: u8;8       },

            (4, 0, 0x02c) => ex!{|s| rotl a: u128,     b: u128;1     },
            (4, 1, 0x02c) => ex!{|s| rotl a: u128,     b: u64;2      },
            (4, 2, 0x02c) => ex!{|s| rotl a: u128,     b: u32;4      },
            (4, 3, 0x02c) => ex!{|s| rotl a: u128,     b: u16;8      },
            (4, 4, 0x02c) => ex!{|s| rotl a: u128,     b: u8;16      },

            (5, 0, 0x02c) => ex!{|s| rotl a: [u32;8],  b: [u32;8];1  },
            (5, 1, 0x02c) => ex!{|s| rotl a: [u32;8],  b: u128;2     },
            (5, 2, 0x02c) => ex!{|s| rotl a: [u32;8],  b: u64;4      },
            (5, 3, 0x02c) => ex!{|s| rotl a: [u32;8],  b: u32;8      },
            (5, 4, 0x02c) => ex!{|s| rotl a: [u32;8],  b: u16;16     },
            (5, 5, 0x02c) => ex!{|s| rotl a: [u32;8],  b: u8;32      },

            (6, 0, 0x02c) => ex!{|s| rotl a: [u32;16], b: [u32;16];1 },
            (6, 1, 0x02c) => ex!{|s| rotl a: [u32;16], b: [u32;8];2  },
            (6, 2, 0x02c) => ex!{|s| rotl a: [u32;16], b: u128;4     },
            (6, 3, 0x02c) => ex!{|s| rotl a: [u32;16], b: u64;8      },
            (6, 4, 0x02c) => ex!{|s| rotl a: [u32;16], b: u32;16     },
            (6, 5, 0x02c) => ex!{|s| rotl a: [u32;16], b: u16;32     },
            (6, 6, 0x02c) => ex!{|s| rotl a: [u32;16], b: u8;64      },

            // rotr
            (0, 0, 0x02d) => ex!{|s| rotr a: u8,       b: u8;1       },

            (1, 0, 0x02d) => ex!{|s| rotr a: u16,      b: u16;1      },
            (1, 1, 0x02d) => ex!{|s| rotr a: u16,      b: u8;2       },

            (2, 0, 0x02d) => ex!{|s| rotr a: u32,      b: u32;1      },
            (2, 1, 0x02d) => ex!{|s| rotr a: u32,      b: u16;2      },
            (2, 2, 0x02d) => ex!{|s| rotr a: u32,      b: u8;4       },

            (3, 0, 0x02d) => ex!{|s| rotr a: u64,      b: u64;1      },
            (3, 1, 0x02d) => ex!{|s| rotr a: u64,      b: u32;2      },
            (3, 2, 0x02d) => ex!{|s| rotr a: u64,      b: u16;4      },
            (3, 3, 0x02d) => ex!{|s| rotr a: u64,      b: u8;8       },

            (4, 0, 0x02d) => ex!{|s| rotr a: u128,     b: u128;1     },
            (4, 1, 0x02d) => ex!{|s| rotr a: u128,     b: u64;2      },
            (4, 2, 0x02d) => ex!{|s| rotr a: u128,     b: u32;4      },
            (4, 3, 0x02d) => ex!{|s| rotr a: u128,     b: u16;8      },
            (4, 4, 0x02d) => ex!{|s| rotr a: u128,     b: u8;16      },

            (5, 0, 0x02d) => ex!{|s| rotr a: [u32;8],  b: [u32;8];1  },
            (5, 1, 0x02d) => ex!{|s| rotr a: [u32;8],  b: u128;2     },
            (5, 2, 0x02d) => ex!{|s| rotr a: [u32;8],  b: u64;4      },
            (5, 3, 0x02d) => ex!{|s| rotr a: [u32;8],  b: u32;8      },
            (5, 4, 0x02d) => ex!{|s| rotr a: [u32;8],  b: u16;16     },
            (5, 5, 0x02d) => ex!{|s| rotr a: [u32;8],  b: u8;32      },

            (6, 0, 0x02d) => ex!{|s| rotr a: [u32;16], b: [u32;16];1 },
            (6, 1, 0x02d) => ex!{|s| rotr a: [u32;16], b: [u32;8];2  },
            (6, 2, 0x02d) => ex!{|s| rotr a: [u32;16], b: u128;4     },
            (6, 3, 0x02d) => ex!{|s| rotr a: [u32;16], b: u64;8      },
            (6, 4, 0x02d) => ex!{|s| rotr a: [u32;16], b: u32;16     },
            (6, 5, 0x02d) => ex!{|s| rotr a: [u32;16], b: u16;32     },
            (6, 6, 0x02d) => ex!{|s| rotr a: [u32;16], b: u8;64      },
