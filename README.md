...
bytecode:
    2001000100010000 u32.arg r1, r1
    2040000200010001 u32.shr_u r2, r1, 0x0001
    2033000300020002 u32.mul r3, r2, r2
    2011000300030001 u32.lt_u r3, r3, r1
    2006000400030000 u32.move r4, r3
    200b000400010002 u32.select r4, r1, r2
    2207000500000000 u8x4.splat r5, 0x00
    200b000300020005 u32.select r3, r2, r5
    202f000500030004 u32.add r5, r3, r4
    2040000500050001 u32.shr_u r5, r5, 0x0001
    2033000200050005 u32.mul r2, r5, r5
    2011000200020001 u32.lt_u r2, r2, r1
    2006000600020000 u32.move r6, r2
    200b000600040005 u32.select r6, r4, r5
    200b000200050003 u32.select r2, r5, r3
    202f000300020006 u32.add r3, r2, r6
    2040000300030001 u32.shr_u r3, r3, 0x0001
    2033000400030003 u32.mul r4, r3, r3
    2011000400040001 u32.lt_u r4, r4, r1
    2006000500040000 u32.move r5, r4
    200b000500060003 u32.select r5, r6, r3
    200b000400030002 u32.select r4, r3, r2
    202f000600040005 u32.add r6, r4, r5
    2040000600060001 u32.shr_u r6, r6, 0x0001
    2033000200060006 u32.mul r2, r6, r6
    2011000200020001 u32.lt_u r2, r2, r1
    2006000300020000 u32.move r3, r2
    200b000300050006 u32.select r3, r5, r6
    200b000200060004 u32.select r2, r6, r4
    202f000600020003 u32.add r6, r2, r3
    2040000600060001 u32.shr_u r6, r6, 0x0001
    2033000400060006 u32.mul r4, r6, r6
    2011000400040001 u32.lt_u r4, r4, r1
    2006000500040000 u32.move r5, r4
    200b000500030006 u32.select r5, r3, r6
    200b000400060002 u32.select r4, r6, r2
    202f000600040005 u32.add r6, r4, r5
    2040000600060001 u32.shr_u r6, r6, 0x0001
    2033000200060006 u32.mul r2, r6, r6
    2011000200020001 u32.lt_u r2, r2, r1
    ...
    2033000400060006 u32.mul r4, r6, r6
    2011000400040001 u32.lt_u r4, r4, r1
    200b000400050006 u32.select r4, r5, r6
    2002000000040000 u32.ret r0, r4
```
...
```
trace:
    u32.arg r1, r1           : 00 00 00 00 10 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
    u32.shr_u r2, r1, 0x0001 : 00 00 00 00 10 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
    u32.mul r3, r2, r2       : 00 00 00 00 10 00 00 00 08 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
    u32.lt_u r3, r3, r1      : 00 00 00 00 10 00 00 00 08 00 00 00 40 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
    u32.move r4, r3          : 00 00 00 00 10 00 00 00 08 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
    u32.select r4, r1, r2    : 00 00 00 00 10 00 00 00 08 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
    u8x4.splat r5            : 00 00 00 00 10 00 00 00 08 00 00 00 00 00 00 00 08 00 00 00 00 00 00 00 00 00 00 00
    u32.select r3, r2, r5    : 00 00 00 00 10 00 00 00 08 00 00 00 00 00 00 00 08 00 00 00 00 00 00 00 00 00 00 00
    u32.add r5, r3, r4       : 00 00 00 00 10 00 00 00 08 00 00 00 00 00 00 00 08 00 00 00 00 00 00 00 00 00 00 00
    u32.shr_u r5, r5, 0x0001 : 00 00 00 00 10 00 00 00 08 00 00 00 00 00 00 00 08 00 00 00 08 00 00 00 00 00 00 00
    u32.mul r2, r5, r5       : 00 00 00 00 10 00 00 00 08 00 00 00 00 00 00 00 08 00 00 00 04 00 00 00 00 00 00 00
    u32.lt_u r2, r2, r1      : 00 00 00 00 10 00 00 00 10 00 00 00 00 00 00 00 08 00 00 00 04 00 00 00 00 00 00 00
    u32.move r6, r2          : 00 00 00 00 10 00 00 00 00 00 00 00 00 00 00 00 08 00 00 00 04 00 00 00 00 00 00 00
    u32.select r6, r4, r5    : 00 00 00 00 10 00 00 00 00 00 00 00 00 00 00 00 08 00 00 00 04 00 00 00 00 00 00 00
    u32.select r2, r5, r3    : 00 00 00 00 10 00 00 00 00 00 00 00 00 00 00 00 08 00 00 00 04 00 00 00 04 00 00 00
    u32.add r3, r2, r6       : 00 00 00 00 10 00 00 00 00 00 00 00 00 00 00 00 08 00 00 00 04 00 00 00 04 00 00 00
    u32.shr_u r3, r3, 0x0001 : 00 00 00 00 10 00 00 00 00 00 00 00 04 00 00 00 08 00 00 00 04 00 00 00 04 00 00 00
    u32.mul r4, r3, r3       : 00 00 00 00 10 00 00 00 00 00 00 00 02 00 00 00 08 00 00 00 04 00 00 00 04 00 00 00
    u32.lt_u r4, r4, r1      : 00 00 00 00 10 00 00 00 00 00 00 00 02 00 00 00 04 00 00 00 04 00 00 00 04 00 00 00
    u32.move r5, r4          : 00 00 00 00 10 00 00 00 00 00 00 00 02 00 00 00 ff ff ff ff 04 00 00 00 04 00 00 00
    u32.select r5, r6, r3    : 00 00 00 00 10 00 00 00 00 00 00 00 02 00 00 00 ff ff ff ff ff ff ff ff 04 00 00 00
    u32.select r4, r3, r2    : 00 00 00 00 10 00 00 00 00 00 00 00 02 00 00 00 ff ff ff ff 04 00 00 00 04 00 00 00
    u32.add r6, r4, r5       : 00 00 00 00 10 00 00 00 00 00 00 00 02 00 00 00 02 00 00 00 04 00 00 00 04 00 00 00
    u32.shr_u r6, r6, 0x0001 : 00 00 00 00 10 00 00 00 00 00 00 00 02 00 00 00 02 00 00 00 04 00 00 00 06 00 00 00
    u32.mul r2, r6, r6       : 00 00 00 00 10 00 00 00 00 00 00 00 02 00 00 00 02 00 00 00 04 00 00 00 03 00 00 00
    u32.lt_u r2, r2, r1      : 00 00 00 00 10 00 00 00 09 00 00 00 02 00 00 00 02 00 00 00 04 00 00 00 03 00 00 00
    u32.move r3, r2          : 00 00 00 00 10 00 00 00 ff ff ff ff 02 00 00 00 02 00 00 00 04 00 00 00 03 00 00 00
    u32.select r3, r5, r6    : 00 00 00 00 10 00 00 00 ff ff ff ff ff ff ff ff 02 00 00 00 04 00 00 00 03 00 00 00
    u32.select r2, r6, r4    : 00 00 00 00 10 00 00 00 ff ff ff ff 04 00 00 00 02 00 00 00 04 00 00 00 03 00 00 00
    u32.add r6, r2, r3       : 00 00 00 00 10 00 00 00 03 00 00 00 04 00 00 00 02 00 00 00 04 00 00 00 03 00 00 00
    u32.shr_u r6, r6, 0x0001 : 00 00 00 00 10 00 00 00 03 00 00 00 04 00 00 00 02 00 00 00 04 00 00 00 07 00 00 00
    u32.mul r4, r6, r6       : 00 00 00 00 10 00 00 00 03 00 00 00 04 00 00 00 02 00 00 00 04 00 00 00 03 00 00 00
    u32.lt_u r4, r4, r1      : 00 00 00 00 10 00 00 00 03 00 00 00 04 00 00 00 09 00 00 00 04 00 00 00 03 00 00 00
    u32.move r5, r4          : 00 00 00 00 10 00 00 00 03 00 00 00 04 00 00 00 ff ff ff ff 04 00 00 00 03 00 00 00
    u32.select r5, r3, r6    : 00 00 00 00 10 00 00 00 03 00 00 00 04 00 00 00 ff ff ff ff ff ff ff ff 03 00 00 00
    u32.select r4, r6, r2    : 00 00 00 00 10 00 00 00 03 00 00 00 04 00 00 00 ff ff ff ff 04 00 00 00 03 00 00 00
    u32.add r6, r4, r5       : 00 00 00 00 10 00 00 00 03 00 00 00 04 00 00 00 03 00 00 00 04 00 00 00 03 00 00 00
    u32.shr_u r6, r6, 0x0001 : 00 00 00 00 10 00 00 00 03 00 00 00 04 00 00 00 03 00 00 00 04 00 00 00 07 00 00 00
    u32.mul r2, r6, r6       : 00 00 00 00 10 00 00 00 03 00 00 00 04 00 00 00 03 00 00 00 04 00 00 00 03 00 00 00
    u32.lt_u r2, r2, r1      : 00 00 00 00 10 00 00 00 09 00 00 00 04 00 00 00 03 00 00 00 04 00 00 00 03 00 00 00
    u32.move r3, r2          : 00 00 00 00 10 00 00 00 ff ff ff ff 04 00 00 00 03 00 00 00 04 00 00 00 03 00 00 00
    u32.select r3, r5, r6    : 00 00 00 00 10 00 00 00 ff ff ff ff ff ff ff ff 03 00 00 00 04 00 00 00 03 00 00 00
    u32.select r2, r6, r4    : 00 00 00 00 10 00 00 00 ff ff ff ff 04 00 00 00 03 00 00 00 04 00 00 00 03 00 00 00
    u32.add r6, r2, r3       : 00 00 00 00 10 00 00 00 03 00 00 00 04 00 00 00 03 00 00 00 04 00 00 00 03 00 00 00
    u32.shr_u r6, r6, 0x0001 : 00 00 00 00 10 00 00 00 03 00 00 00 04 00 00 00 03 00 00 00 04 00 00 00 07 00 00 00
    u32.mul r4, r6, r6       : 00 00 00 00 10 00 00 00 03 00 00 00 04 00 00 00 03 00 00 00 04 00 00 00 03 00 00 00
    u32.lt_u r4, r4, r1      : 00 00 00 00 10 00 00 00 03 00 00 00 04 00 00 00 09 00 00 00 04 00 00 00 03 00 00 00
    u32.move r5, r4          : 00 00 00 00 10 00 00 00 03 00 00 00 04 00 00 00 ff ff ff ff 04 00 00 00 03 00 00 00
    u32.select r5, r3, r6    : 00 00 00 00 10 00 00 00 03 00 00 00 04 00 00 00 ff ff ff ff ff ff ff ff 03 00 00 00
    u32.select r4, r6, r2    : 00 00 00 00 10 00 00 00 03 00 00 00 04 00 00 00 ff ff ff ff 04 00 00 00 03 00 00 00
    ...
    u32.mul r4, r6, r6       : 00 00 00 00 10 00 00 00 03 00 00 00 04 00 00 00 03 00 00 00 04 00 00 00 03 00 00 00
    u32.lt_u r4, r4, r1      : 00 00 00 00 10 00 00 00 03 00 00 00 04 00 00 00 09 00 00 00 04 00 00 00 03 00 00 00
    u32.select r4, r5, r6    : 00 00 00 00 10 00 00 00 03 00 00 00 04 00 00 00 ff ff ff ff 04 00 00 00 03 00 00 00
    u32.ret r0, r4           : 00 00 00 00 10 00 00 00 03 00 00 00 04 00 00 00 04 00 00 00 04 00 00 00 03 00 00 00
result:
    0x00000004
```
