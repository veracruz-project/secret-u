...
bytecode:
    ...
    2001000200020000 u32.arg r2, r2
    2001000300030000 u32.arg r3, r3
    2025000400010002 u32.add r4, r1, r2
    2009000500000001 u32.move_c r5, 0x00000001
    2028000400040005 u32.and r4, r4, r5
    2009000500000001 u32.move_c r5, 0x00000001
    2011000400040005 u32.eq r4, r4, r5
    220a000100040000 u8x4.extract r1, r4[0]
    0009000000000000 u8.move_c r0, 0x00
    2027000200020002 u32.mul r2, r2, r2
    2027000100010001 u32.mul r1, r1, r1
    2025000200010002 u32.add r2, r1, r2
    2027000300030003 u32.mul r3, r3, r3
    2011000100020003 u32.eq r1, r2, r3
    220a000200010000 u8x4.extract r2, r1[0]
    000c000000010002 u8.select r0, r1, r2
    0002000000000000 u8.ret r0, r0
```
...
trace:
    ...
    u32.add r4, r1, r2       : 00 00 00 00 03 00 00 00 04 00 00 00 05 00 00 00 00 00 00 00 00 00 00 00
    u32.move_c r5            : 00 00 00 00 03 00 00 00 04 00 00 00 05 00 00 00 07 00 00 00 00 00 00 00
    u32.and r4, r4, r5       : 00 00 00 00 03 00 00 00 04 00 00 00 05 00 00 00 07 00 00 00 01 00 00 00
    u32.move_c r5            : 00 00 00 00 03 00 00 00 04 00 00 00 05 00 00 00 01 00 00 00 01 00 00 00
    u32.eq r4, r4, r5        : 00 00 00 00 03 00 00 00 04 00 00 00 05 00 00 00 01 00 00 00 01 00 00 00
    ...
    u32.mul r2, r2, r2       : 00 ff 00 00 03 00 00 00 04 00 00 00 05 00 00 00 ff ff ff ff 01 00 00 00
    u32.mul r1, r1, r1       : 00 ff 00 00 03 00 00 00 10 00 00 00 05 00 00 00 ff ff ff ff 01 00 00 00
    u32.add r2, r1, r2       : 00 ff 00 00 09 00 00 00 10 00 00 00 05 00 00 00 ff ff ff ff 01 00 00 00
    u32.mul r3, r3, r3       : 00 ff 00 00 09 00 00 00 19 00 00 00 05 00 00 00 ff ff ff ff 01 00 00 00
    u32.eq r1, r2, r3        : 00 ff 00 00 09 00 00 00 19 00 00 00 19 00 00 00 ff ff ff ff 01 00 00 00
    u8x4.extract r2, r1[0]   : 00 ff 00 00 ff ff ff ff 19 00 00 00 19 00 00 00 ff ff ff ff 01 00 00 00
    u8.select r0, r1, r2     : 00 ff ff 00 ff ff ff ff 19 00 00 00 19 00 00 00 ff ff ff ff 01 00 00 00
    u8.ret r0, r0            : ff ff ff 00 ff ff ff ff 19 00 00 00 19 00 00 00 ff ff ff ff 01 00 00 00
result:
    0xff
```
...
bytecode:
    2001000100010000 u32.arg r1, r1
    2009000200000001 u32.move_c r2, 0x00000001
    202d000200010002 u32.shr_u r2, r1, r2
    2027000300020002 u32.mul r3, r2, r2
    2013000300030001 u32.lt_u r3, r3, r1
    2006000400020000 u32.move r4, r2
    200c000400010003 u32.select r4, r1, r3
    2009000500000000 u32.move_c r5, 0x00000000
    200c000500020003 u32.select r5, r2, r3
    2025000200050004 u32.add r2, r5, r4
    2009000300000001 u32.move_c r3, 0x00000001
    202d000200020003 u32.shr_u r2, r2, r3
    2027000300020002 u32.mul r3, r2, r2
    2013000300030001 u32.lt_u r3, r3, r1
    2006000600020000 u32.move r6, r2
    200c000600040003 u32.select r6, r4, r3
    200c000500020003 u32.select r5, r2, r3
    2025000400050006 u32.add r4, r5, r6
    2009000200000001 u32.move_c r2, 0x00000001
    202d000400040002 u32.shr_u r4, r4, r2
    2027000200040004 u32.mul r2, r4, r4
    2013000200020001 u32.lt_u r2, r2, r1
    2006000300040000 u32.move r3, r4
    200c000300060002 u32.select r3, r6, r2
    200c000500040002 u32.select r5, r4, r2
    2025000600050003 u32.add r6, r5, r3
    2009000200000001 u32.move_c r2, 0x00000001
    202d000600060002 u32.shr_u r6, r6, r2
    2027000200060006 u32.mul r2, r6, r6
    2013000200020001 u32.lt_u r2, r2, r1
    200c000600030002 u32.select r6, r3, r2
    2002000000060000 u32.ret r0, r6
```
...
trace:
    ...
    u32.move_c r2            : 00 00 00 00 10 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
    u32.shr_u r2, r1, r2     : 00 00 00 00 10 00 00 00 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
    ...
    u32.move r4, r2          : 00 00 00 00 10 00 00 00 08 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
    u32.select r4, r1, r3    : 00 00 00 00 10 00 00 00 08 00 00 00 00 00 00 00 08 00 00 00 00 00 00 00 00 00 00 00
    u32.move_c r5            : 00 00 00 00 10 00 00 00 08 00 00 00 00 00 00 00 08 00 00 00 00 00 00 00 00 00 00 00
    u32.select r5, r2, r3    : 00 00 00 00 10 00 00 00 08 00 00 00 00 00 00 00 08 00 00 00 00 00 00 00 00 00 00 00
    u32.add r2, r5, r4       : 00 00 00 00 10 00 00 00 08 00 00 00 00 00 00 00 08 00 00 00 00 00 00 00 00 00 00 00
    u32.move_c r3            : 00 00 00 00 10 00 00 00 08 00 00 00 00 00 00 00 08 00 00 00 00 00 00 00 00 00 00 00
    u32.shr_u r2, r2, r3     : 00 00 00 00 10 00 00 00 08 00 00 00 01 00 00 00 08 00 00 00 00 00 00 00 00 00 00 00
    u32.mul r3, r2, r2       : 00 00 00 00 10 00 00 00 04 00 00 00 01 00 00 00 08 00 00 00 00 00 00 00 00 00 00 00
    u32.lt_u r3, r3, r1      : 00 00 00 00 10 00 00 00 04 00 00 00 10 00 00 00 08 00 00 00 00 00 00 00 00 00 00 00
    u32.move r6, r2          : 00 00 00 00 10 00 00 00 04 00 00 00 00 00 00 00 08 00 00 00 00 00 00 00 00 00 00 00
    u32.select r6, r4, r3    : 00 00 00 00 10 00 00 00 04 00 00 00 00 00 00 00 08 00 00 00 00 00 00 00 04 00 00 00
    u32.select r5, r2, r3    : 00 00 00 00 10 00 00 00 04 00 00 00 00 00 00 00 08 00 00 00 00 00 00 00 04 00 00 00
    u32.add r4, r5, r6       : 00 00 00 00 10 00 00 00 04 00 00 00 00 00 00 00 08 00 00 00 00 00 00 00 04 00 00 00
    u32.move_c r2            : 00 00 00 00 10 00 00 00 04 00 00 00 00 00 00 00 04 00 00 00 00 00 00 00 04 00 00 00
    u32.shr_u r4, r4, r2     : 00 00 00 00 10 00 00 00 01 00 00 00 00 00 00 00 04 00 00 00 00 00 00 00 04 00 00 00
    u32.mul r2, r4, r4       : 00 00 00 00 10 00 00 00 01 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 04 00 00 00
    u32.lt_u r2, r2, r1      : 00 00 00 00 10 00 00 00 04 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 04 00 00 00
    u32.move r3, r4          : 00 00 00 00 10 00 00 00 ff ff ff ff 00 00 00 00 02 00 00 00 00 00 00 00 04 00 00 00
    u32.select r3, r6, r2    : 00 00 00 00 10 00 00 00 ff ff ff ff 02 00 00 00 02 00 00 00 00 00 00 00 04 00 00 00
    u32.select r5, r4, r2    : 00 00 00 00 10 00 00 00 ff ff ff ff 04 00 00 00 02 00 00 00 00 00 00 00 04 00 00 00
    u32.add r6, r5, r3       : 00 00 00 00 10 00 00 00 ff ff ff ff 04 00 00 00 02 00 00 00 02 00 00 00 04 00 00 00
    u32.move_c r2            : 00 00 00 00 10 00 00 00 ff ff ff ff 04 00 00 00 02 00 00 00 02 00 00 00 06 00 00 00
    u32.shr_u r6, r6, r2     : 00 00 00 00 10 00 00 00 01 00 00 00 04 00 00 00 02 00 00 00 02 00 00 00 06 00 00 00
    u32.mul r2, r6, r6       : 00 00 00 00 10 00 00 00 01 00 00 00 04 00 00 00 02 00 00 00 02 00 00 00 03 00 00 00
    u32.lt_u r2, r2, r1      : 00 00 00 00 10 00 00 00 09 00 00 00 04 00 00 00 02 00 00 00 02 00 00 00 03 00 00 00
    u32.select r6, r3, r2    : 00 00 00 00 10 00 00 00 ff ff ff ff 04 00 00 00 02 00 00 00 02 00 00 00 03 00 00 00
    u32.ret r0, r6           : 00 00 00 00 10 00 00 00 ff ff ff ff 04 00 00 00 02 00 00 00 02 00 00 00 04 00 00 00
result:
    0x00000004
```
...
On my machine:
```
sha256_reference  0m0.015s
sha256            0m20.929s
sha256_fast       0m0.135s
```
...
On my machine:
```
aes_reference           0m0.030s
aes_shuffle             0m0.665s
aes_bitslice            0m12.989s
aes_more_simd_shuffle   0m0.290ss
aes_more_simd_bitslice  0m4.438s
```
...
On my machine:
```
chacha20_reference  0m0.020s
chacha20            0m0.076s
chacha20_simd       0m0.047s
```
