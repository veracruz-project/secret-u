...
```
slots:
    00 00 00 00 cc cc cc cc cc cc cc cc cc cc cc cc 00 00 00 00
bytecode:
    2001000100010000 u32.arg r1, r1
    2001000200020000 u32.arg r2, r2
    2001000300030000 u32.arg r3, r3
    202f000400010002 u32.add r4, r1, r2
    2036000400040001 u32.and r4, r4, 0x0001
    200e000400040001 u32.eq r4, r4, 0x0001
    2205000100040000 u8.truncate r1, r4, u32
    0007000000000000 u8.move r0, 0x00
    2033000400020002 u32.mul r4, r2, r2
    2033000200010001 u32.mul r2, r1, r1
    202f000400020004 u32.add r4, r2, r4
    2033000100030003 u32.mul r1, r3, r3
    200d000400040001 u32.eq r4, r4, r1
    2205000200040000 u8.truncate r2, r4, u32
    000b000000010002 u8.select r0, r1, r2
...
```
trace:
    u32.arg r1, r1           : 00 00 00 00 03 00 00 00 04 00 00 00 05 00 00 00 00 00 00 00
    u32.arg r2, r2           : 00 00 00 00 03 00 00 00 04 00 00 00 05 00 00 00 00 00 00 00
    u32.arg r3, r3           : 00 00 00 00 03 00 00 00 04 00 00 00 05 00 00 00 00 00 00 00
    u32.add r4, r1, r2       : 00 00 00 00 03 00 00 00 04 00 00 00 05 00 00 00 00 00 00 00
    u32.and r4, r4, 0x0001   : 00 00 00 00 03 00 00 00 04 00 00 00 05 00 00 00 07 00 00 00
    u32.eq r4, r4, 0x0001    : 00 00 00 00 03 00 00 00 04 00 00 00 05 00 00 00 01 00 00 00
    u8.truncate r1, r4, u32  : 00 00 00 00 03 00 00 00 04 00 00 00 05 00 00 00 ff ff ff ff
    u8.move r0               : 00 ff 00 00 03 00 00 00 04 00 00 00 05 00 00 00 ff ff ff ff
    u32.mul r4, r2, r2       : 00 ff 00 00 03 00 00 00 04 00 00 00 05 00 00 00 ff ff ff ff
    u32.mul r2, r1, r1       : 00 ff 00 00 03 00 00 00 04 00 00 00 05 00 00 00 10 00 00 00
    u32.add r4, r2, r4       : 00 ff 00 00 03 00 00 00 09 00 00 00 05 00 00 00 10 00 00 00
    u32.mul r1, r3, r3       : 00 ff 00 00 03 00 00 00 09 00 00 00 05 00 00 00 19 00 00 00
    u32.eq r4, r4, r1        : 00 ff 00 00 19 00 00 00 09 00 00 00 05 00 00 00 19 00 00 00
    u8.truncate r2, r4, u32  : 00 ff 00 00 19 00 00 00 09 00 00 00 05 00 00 00 ff ff ff ff
    u8.select r0, r1, r2     : 00 ff ff 00 19 00 00 00 09 00 00 00 05 00 00 00 ff ff ff ff
    u8.ret r0, r0            : ff ff ff 00 19 00 00 00 09 00 00 00 05 00 00 00 ff ff ff ff
result:
    0xff
```
...
bytecode:
    ...
    200b000400010003 u32.select r4, r1, r3
    2207000500000000 u8x4.splat r5, 0x00
    200b000500020003 u32.select r5, r2, r3
    202f000200050004 u32.add r2, r5, r4
    2040000200020001 u32.shr_u r2, r2, 0x0001
    2033000300020002 u32.mul r3, r2, r2
    2011000300030001 u32.lt_u r3, r3, r1
    2006000600020000 u32.move r6, r2
    200b000600040003 u32.select r6, r4, r3
    200b000500020003 u32.select r5, r2, r3
    202f000400050006 u32.add r4, r5, r6
    2040000400040001 u32.shr_u r4, r4, 0x0001
    2033000200040004 u32.mul r2, r4, r4
    2011000200020001 u32.lt_u r2, r2, r1
    2006000300040000 u32.move r3, r4
    200b000300060002 u32.select r3, r6, r2
    200b000500040002 u32.select r5, r4, r2
    202f000600050003 u32.add r6, r5, r3
    2040000600060001 u32.shr_u r6, r6, 0x0001
    2033000200060006 u32.mul r2, r6, r6
    2011000200020001 u32.lt_u r2, r2, r1
    200b000600030002 u32.select r6, r3, r2
...
trace:
    ...
    u32.shr_u r2, r2, 0x0001 : 00 00 00 00 10 00 00 00 08 00 00 00 00 00 00 00 08 00 00 00 00 00 00 00 00 00 00 00
    u32.mul r3, r2, r2       : 00 00 00 00 10 00 00 00 04 00 00 00 00 00 00 00 08 00 00 00 00 00 00 00 00 00 00 00
    ...
    u32.shr_u r4, r4, 0x0001 : 00 00 00 00 10 00 00 00 04 00 00 00 00 00 00 00 04 00 00 00 00 00 00 00 04 00 00 00
    u32.mul r2, r4, r4       : 00 00 00 00 10 00 00 00 04 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 04 00 00 00
    ...
    u32.shr_u r6, r6, 0x0001 : 00 00 00 00 10 00 00 00 ff ff ff ff 04 00 00 00 02 00 00 00 02 00 00 00 06 00 00 00
    u32.mul r2, r6, r6       : 00 00 00 00 10 00 00 00 ff ff ff ff 04 00 00 00 02 00 00 00 02 00 00 00 03 00 00 00
...
On my machine:
```
sha256_reference  0m0.016s
sha256            0m18.855s
sha256_fast       0m0.167s
```
...
On my machine:
```
aes_reference           0m0.031s
aes_shuffle             0m0.685s
aes_bitslice            0m13.250s
aes_more_simd_shuffle   0m0.283s
aes_more_simd_bitslice  0m5.022s
```
...
On my machine:
```
chacha20_reference  0m0.022s
chacha20            0m0.091s
chacha20_simd       0m0.053s
```
...
sss_bitslice       0m0.038s
sss_simd_bitslice  0m0.019s
```
